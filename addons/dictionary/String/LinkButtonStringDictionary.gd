...
# where keys are of type 'String' and values of type 'LinkButton'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name LinkButtonDictionary
...
func _assert_not_null_LinkButton(value: LinkButton):
    if (!value is LinkButton):
        _crash("Was expecting type 'LinkButton'")
