...
# where keys are of type 'String' and values of type 'AudioStreamMP3'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioStreamMP3Dictionary
...
func _assert_not_null_AudioStreamMP3(value: AudioStreamMP3):
    if (!value is AudioStreamMP3):
        _crash("Was expecting type 'AudioStreamMP3'")
