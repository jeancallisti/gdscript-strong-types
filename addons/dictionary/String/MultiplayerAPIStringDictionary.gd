...
# where keys are of type 'String' and values of type 'MultiplayerAPI'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MultiplayerAPIDictionary
...
func _assert_not_null_MultiplayerAPI(value: MultiplayerAPI):
    if (!value is MultiplayerAPI):
        _crash("Was expecting type 'MultiplayerAPI'")
