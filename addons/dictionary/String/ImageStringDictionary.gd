...
# where keys are of type 'String' and values of type 'Image'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ImageDictionary
...
func _assert_not_null_Image(value: Image):
    if (!value is Image):
        _crash("Was expecting type 'Image'")
