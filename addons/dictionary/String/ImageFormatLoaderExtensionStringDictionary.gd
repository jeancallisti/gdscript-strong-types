...
# where keys are of type 'String' and values of type 'ImageFormatLoaderExtension'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ImageFormatLoaderExtensionDictionary
...
func _assert_not_null_ImageFormatLoaderExtension(value: ImageFormatLoaderExtension):
    if (!value is ImageFormatLoaderExtension):
        _crash("Was expecting type 'ImageFormatLoaderExtension'")
...
func set(key: String, value: ImageFormatLoaderExtension):
    _assert_not_null_String(key)
    _assert_not_null_ImageFormatLoaderExtension(value)
    d[key] = value

# same as set but allows null values
func set_nullable(key: String, value: ImageFormatLoaderExtension):
    _assert_not_null_String(key)
    _assert_nullable_ImageFormatLoaderExtension(value)
    d[key] = value

func get(key: String) -> ImageFormatLoaderExtension:
    _assert_not_null_String(key)
    return d[key]	
