...
# where keys are of type 'String' and values of type 'CameraTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CameraTextureDictionary
...
func _assert_not_null_CameraTexture(value: CameraTexture):
    if (!value is CameraTexture):
        _crash("Was expecting type 'CameraTexture'")
