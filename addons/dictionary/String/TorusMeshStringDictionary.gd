...
# where keys are of type 'String' and values of type 'TorusMesh'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TorusMeshDictionary
...
func _assert_not_null_TorusMesh(value: TorusMesh):
    if (!value is TorusMesh):
        _crash("Was expecting type 'TorusMesh'")
