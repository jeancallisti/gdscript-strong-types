...
# where keys are of type 'String' and values of type 'VisualServer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualServerDictionary
...
func _assert_not_null_VisualServer(value: VisualServer):
    if (!value is VisualServer):
        _crash("Was expecting type 'VisualServer'")
