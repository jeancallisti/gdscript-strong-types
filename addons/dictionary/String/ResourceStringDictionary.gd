...
# where keys are of type 'String' and values of type 'Resource'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ResourceDictionary
...
func _assert_not_null_Resource(value: Resource):
    if (!value is Resource):
        _crash("Was expecting type 'Resource'")
...
func set_nullable(key: String, value: Resource):
    _assert_not_null_String(key)
