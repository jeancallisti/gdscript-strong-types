...
# where keys are of type 'String' and values of type 'SceneTreeTween'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SceneTreeTweenDictionary
...
func _assert_not_null_SceneTreeTween(value: SceneTreeTween):
    if (!value is SceneTreeTween):
        _crash("Was expecting type 'SceneTreeTween'")
