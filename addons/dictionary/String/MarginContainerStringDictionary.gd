...
# where keys are of type 'String' and values of type 'MarginContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MarginContainerDictionary
...
func _assert_not_null_MarginContainer(value: MarginContainer):
    if (!value is MarginContainer):
        _crash("Was expecting type 'MarginContainer'")
