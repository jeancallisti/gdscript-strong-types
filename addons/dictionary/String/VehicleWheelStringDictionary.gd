...
# where keys are of type 'String' and values of type 'VehicleWheel'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VehicleWheelDictionary
...
func _assert_not_null_VehicleWheel(value: VehicleWheel):
    if (!value is VehicleWheel):
        _crash("Was expecting type 'VehicleWheel'")
