...
# where keys are of type 'String' and values of type 'MeshLibrary'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MeshLibraryDictionary
...
func _assert_not_null_MeshLibrary(value: MeshLibrary):
    if (!value is MeshLibrary):
        _crash("Was expecting type 'MeshLibrary'")
