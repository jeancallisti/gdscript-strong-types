...
# where keys are of type 'String' and values of type 'EditorScript'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name EditorScriptDictionary
...
func _assert_not_null_EditorScript(value: EditorScript):
    if (!value is EditorScript):
        _crash("Was expecting type 'EditorScript'")
