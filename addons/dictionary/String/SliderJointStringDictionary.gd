...
# where keys are of type 'String' and values of type 'SliderJoint'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SliderJointDictionary
...
func _assert_not_null_SliderJoint(value: SliderJoint):
    if (!value is SliderJoint):
        _crash("Was expecting type 'SliderJoint'")
