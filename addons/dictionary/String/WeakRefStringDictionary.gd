...
# where keys are of type 'String' and values of type 'WeakRef'.
...
func _assert_not_null_WeakRef(value: WeakRef):
    if (!value is WeakRef):
        _crash("Was expecting type 'WeakRef'")
