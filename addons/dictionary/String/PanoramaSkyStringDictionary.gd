...
# where keys are of type 'String' and values of type 'PanoramaSky'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PanoramaSkyDictionary
...
func _assert_not_null_PanoramaSky(value: PanoramaSky):
    if (!value is PanoramaSky):
        _crash("Was expecting type 'PanoramaSky'")
