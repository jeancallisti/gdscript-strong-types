...
# where keys are of type 'String' and values of type 'Tween'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TweenDictionary
...
func _assert_not_null_Tween(value: Tween):
    if (!value is Tween):
        _crash("Was expecting type 'Tween'")
