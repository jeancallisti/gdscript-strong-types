...
# where keys are of type 'String' and values of type 'PluginScript'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PluginScriptDictionary
...
func _assert_not_null_PluginScript(value: PluginScript):
    if (!value is PluginScript):
        _crash("Was expecting type 'PluginScript'")
