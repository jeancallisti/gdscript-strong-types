...
# where keys are of type 'String' and values of type 'Material'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MaterialDictionary
...
func _assert_not_null_Material(value: Material):
    if (!value is Material):
        _crash("Was expecting type 'Material'")
