...
# where keys are of type 'String' and values of type 'Theme'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ThemeDictionary
...
func _assert_not_null_Theme(value: Theme):
    if (!value is Theme):
        _crash("Was expecting type 'Theme'")
