...
# where keys are of type 'String' and values of type 'Node'.
...
func _assert_not_null_Node(value: Node):
    if (!value is Node):
        _crash("Was expecting type 'Node'")
