...
# where keys are of type 'String' and values of type 'EditorProperty'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name EditorPropertyDictionary
...
func _assert_not_null_EditorProperty(value: EditorProperty):
    if (!value is EditorProperty):
        _crash("Was expecting type 'EditorProperty'")
