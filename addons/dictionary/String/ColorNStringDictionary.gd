...
# where keys are of type 'String' and values of type 'ColorN'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ColorNDictionary
...
func _assert_not_null_ColorN(value: ColorN):
    if (!value is ColorN):
        _crash("Was expecting type 'ColorN'")
