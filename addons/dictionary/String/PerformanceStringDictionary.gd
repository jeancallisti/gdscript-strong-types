...
# where keys are of type 'String' and values of type 'Performance'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PerformanceDictionary
...
func _assert_not_null_Performance(value: Performance):
    if (!value is Performance):
        _crash("Was expecting type 'Performance'")
