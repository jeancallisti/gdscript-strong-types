...
# where keys are of type 'String' and values of type 'GLTFSpecGloss'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name GLTFSpecGlossDictionary
...
func _assert_not_null_GLTFSpecGloss(value: GLTFSpecGloss):
    if (!value is GLTFSpecGloss):
        _crash("Was expecting type 'GLTFSpecGloss'")
