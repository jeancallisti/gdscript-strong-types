...
# where keys are of type 'String' and values of type 'AudioEffectBandLimitFilter'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioEffectBandLimitFilterDictionary
...
func _assert_not_null_AudioEffectBandLimitFilter(value: AudioEffectBandLimitFilter):
    if (!value is AudioEffectBandLimitFilter):
        _crash("Was expecting type 'AudioEffectBandLimitFilter'")
...
func set(key: String, value: AudioEffectBandLimitFilter):
    _assert_not_null_String(key)
    _assert_not_null_AudioEffectBandLimitFilter(value)
    d[key] = value

# same as set but allows null values
func set_nullable(key: String, value: AudioEffectBandLimitFilter):
    _assert_not_null_String(key)
    _assert_nullable_AudioEffectBandLimitFilter(value)
    d[key] = value

func get(key: String) -> AudioEffectBandLimitFilter:
    _assert_not_null_String(key)
    return d[key]	
