...
# where keys are of type 'String' and values of type 'EditorSettings'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name EditorSettingsDictionary
...
func _assert_not_null_EditorSettings(value: EditorSettings):
    if (!value is EditorSettings):
        _crash("Was expecting type 'EditorSettings'")
