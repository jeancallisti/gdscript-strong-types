...
# where keys are of type 'String' and values of type 'ParallaxLayer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ParallaxLayerDictionary
...
func _assert_not_null_ParallaxLayer(value: ParallaxLayer):
    if (!value is ParallaxLayer):
        _crash("Was expecting type 'ParallaxLayer'")
