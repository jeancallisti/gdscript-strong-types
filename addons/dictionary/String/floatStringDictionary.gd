...
# where keys are of type 'String' and values of type 'float'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name floatDictionary
...
func _assert_not_null_float(value: float):
    if (!value is float):
        _crash("Was expecting type 'float'")
...
func set_nullable(key: String, value: float):
    _assert_not_null_String(key)
