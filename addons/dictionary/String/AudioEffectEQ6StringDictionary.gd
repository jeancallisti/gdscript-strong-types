...
# where keys are of type 'String' and values of type 'AudioEffectEQ6'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioEffectEQ6Dictionary
...
func _assert_not_null_AudioEffectEQ6(value: AudioEffectEQ6):
    if (!value is AudioEffectEQ6):
        _crash("Was expecting type 'AudioEffectEQ6'")
