...
# where keys are of type 'String' and values of type 'CapsuleShape'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CapsuleShapeDictionary
...
func _assert_not_null_CapsuleShape(value: CapsuleShape):
    if (!value is CapsuleShape):
        _crash("Was expecting type 'CapsuleShape'")
