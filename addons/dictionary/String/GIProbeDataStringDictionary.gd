...
# where keys are of type 'String' and values of type 'GIProbeData'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name GIProbeDataDictionary
...
func _assert_not_null_GIProbeData(value: GIProbeData):
    if (!value is GIProbeData):
        _crash("Was expecting type 'GIProbeData'")
