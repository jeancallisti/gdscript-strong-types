...
# where keys are of type 'String' and values of type 'PhysicsTestMotionResult'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PhysicsTestMotionResultDictionary
...
func _assert_not_null_PhysicsTestMotionResult(value: PhysicsTestMotionResult):
    if (!value is PhysicsTestMotionResult):
        _crash("Was expecting type 'PhysicsTestMotionResult'")
