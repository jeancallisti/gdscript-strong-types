...
# where keys are of type 'String' and values of type 'CSGSphere'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CSGSphereDictionary
...
func _assert_not_null_CSGSphere(value: CSGSphere):
    if (!value is CSGSphere):
        _crash("Was expecting type 'CSGSphere'")
