...
# where keys are of type 'String' and values of type 'Particles'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ParticlesDictionary
...
func _assert_not_null_Particles(value: Particles):
    if (!value is Particles):
        _crash("Was expecting type 'Particles'")
