...
# where keys are of type 'String' and values of type 'Variant'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VariantDictionary
...
func _assert_not_null_Variant(value: Variant):
    if (!value is Variant):
        _crash("Was expecting type 'Variant'")
...
func set_nullable(key: String, value: Variant):
    _assert_not_null_String(key)
