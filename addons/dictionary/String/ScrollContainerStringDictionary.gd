...
# where keys are of type 'String' and values of type 'ScrollContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ScrollContainerDictionary
...
func _assert_not_null_ScrollContainer(value: ScrollContainer):
    if (!value is ScrollContainer):
        _crash("Was expecting type 'ScrollContainer'")
