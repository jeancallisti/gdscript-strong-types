...
# where keys are of type 'String' and values of type 'VisualShaderNodeVectorLen'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualShaderNodeVectorLenDictionary
...
func _assert_not_null_VisualShaderNodeVectorLen(value: VisualShaderNodeVectorLen):
    if (!value is VisualShaderNodeVectorLen):
        _crash("Was expecting type 'VisualShaderNodeVectorLen'")
