...
# where keys are of type 'String' and values of type 'ColorPicker'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ColorPickerDictionary
...
func _assert_not_null_ColorPicker(value: ColorPicker):
    if (!value is ColorPicker):
        _crash("Was expecting type 'ColorPicker'")
