...
# where keys are of type 'String' and values of type 'Basis'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BasisDictionary
...
func _assert_not_null_Basis(value: Basis):
    if (!value is Basis):
        _crash("Was expecting type 'Basis'")
