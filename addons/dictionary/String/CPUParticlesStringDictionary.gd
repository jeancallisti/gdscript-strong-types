...
# where keys are of type 'String' and values of type 'CPUParticles'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CPUParticlesDictionary
...
func _assert_not_null_CPUParticles(value: CPUParticles):
    if (!value is CPUParticles):
        _crash("Was expecting type 'CPUParticles'")
