...
# where keys are of type 'String' and values of type 'JavaClass'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name JavaClassDictionary
...
func _assert_not_null_JavaClass(value: JavaClass):
    if (!value is JavaClass):
        _crash("Was expecting type 'JavaClass'")
