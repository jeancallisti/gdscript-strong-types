...
# where keys are of type 'String' and values of type 'Color8'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Color8Dictionary
...
func _assert_not_null_Color8(value: Color8):
    if (!value is Color8):
        _crash("Was expecting type 'Color8'")
