...
# where keys are of type 'String' and values of type 'ConeTwistJoint'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ConeTwistJointDictionary
...
func _assert_not_null_ConeTwistJoint(value: ConeTwistJoint):
    if (!value is ConeTwistJoint):
        _crash("Was expecting type 'ConeTwistJoint'")
