...
# where keys are of type 'String' and values of type 'Tabs'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TabsDictionary
...
func _assert_not_null_Tabs(value: Tabs):
    if (!value is Tabs):
        _crash("Was expecting type 'Tabs'")
