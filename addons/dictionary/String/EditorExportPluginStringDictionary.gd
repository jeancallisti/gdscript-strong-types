...
# where keys are of type 'String' and values of type 'EditorExportPlugin'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name EditorExportPluginDictionary
...
func _assert_not_null_EditorExportPlugin(value: EditorExportPlugin):
    if (!value is EditorExportPlugin):
        _crash("Was expecting type 'EditorExportPlugin'")
