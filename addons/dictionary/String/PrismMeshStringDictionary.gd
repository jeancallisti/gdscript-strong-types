...
# where keys are of type 'String' and values of type 'PrismMesh'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PrismMeshDictionary
...
func _assert_not_null_PrismMesh(value: PrismMesh):
    if (!value is PrismMesh):
        _crash("Was expecting type 'PrismMesh'")
