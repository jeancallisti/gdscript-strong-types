...
# where keys are of type 'String' and values of type 'VisualInstance'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualInstanceDictionary
...
func _assert_not_null_VisualInstance(value: VisualInstance):
    if (!value is VisualInstance):
        _crash("Was expecting type 'VisualInstance'")
