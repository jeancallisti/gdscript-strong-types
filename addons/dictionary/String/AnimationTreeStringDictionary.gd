...
# where keys are of type 'String' and values of type 'AnimationTree'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AnimationTreeDictionary
...
func _assert_not_null_AnimationTree(value: AnimationTree):
    if (!value is AnimationTree):
        _crash("Was expecting type 'AnimationTree'")
