...
# where keys are of type 'String' and values of type 'PackedScene'.
...
func _assert_not_null_PackedScene(value: PackedScene):
    if (!value is PackedScene):
        _crash("Was expecting type 'PackedScene'")
