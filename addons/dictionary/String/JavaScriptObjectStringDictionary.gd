...
# where keys are of type 'String' and values of type 'JavaScriptObject'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name JavaScriptObjectDictionary
...
func _assert_not_null_JavaScriptObject(value: JavaScriptObject):
    if (!value is JavaScriptObject):
        _crash("Was expecting type 'JavaScriptObject'")
