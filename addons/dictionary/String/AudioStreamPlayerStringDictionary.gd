...
# where keys are of type 'String' and values of type 'AudioStreamPlayer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioStreamPlayerDictionary
...
func _assert_not_null_AudioStreamPlayer(value: AudioStreamPlayer):
    if (!value is AudioStreamPlayer):
        _crash("Was expecting type 'AudioStreamPlayer'")
