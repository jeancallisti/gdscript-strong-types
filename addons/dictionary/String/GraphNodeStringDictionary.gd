...
# where keys are of type 'String' and values of type 'GraphNode'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name GraphNodeDictionary
...
func _assert_not_null_GraphNode(value: GraphNode):
    if (!value is GraphNode):
        _crash("Was expecting type 'GraphNode'")
