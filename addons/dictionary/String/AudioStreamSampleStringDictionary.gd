...
# where keys are of type 'String' and values of type 'AudioStreamSample'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioStreamSampleDictionary
...
func _assert_not_null_AudioStreamSample(value: AudioStreamSample):
    if (!value is AudioStreamSample):
        _crash("Was expecting type 'AudioStreamSample'")
