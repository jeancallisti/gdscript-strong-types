...
# where keys are of type 'String' and values of type 'MethodTweener'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MethodTweenerDictionary
...
func _assert_not_null_MethodTweener(value: MethodTweener):
    if (!value is MethodTweener):
        _crash("Was expecting type 'MethodTweener'")
