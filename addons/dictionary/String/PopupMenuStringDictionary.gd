...
# where keys are of type 'String' and values of type 'PopupMenu'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PopupMenuDictionary
...
func _assert_not_null_PopupMenu(value: PopupMenu):
    if (!value is PopupMenu):
        _crash("Was expecting type 'PopupMenu'")
