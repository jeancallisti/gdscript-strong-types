...
# where keys are of type 'String' and values of type 'ScrollBar'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ScrollBarDictionary
...
func _assert_not_null_ScrollBar(value: ScrollBar):
    if (!value is ScrollBar):
        _crash("Was expecting type 'ScrollBar'")
