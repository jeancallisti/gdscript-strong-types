...
# where keys are of type 'String' and values of type 'ViewportTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ViewportTextureDictionary
...
func _assert_not_null_ViewportTexture(value: ViewportTexture):
    if (!value is ViewportTexture):
        _crash("Was expecting type 'ViewportTexture'")
