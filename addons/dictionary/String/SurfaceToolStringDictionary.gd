...
# where keys are of type 'String' and values of type 'SurfaceTool'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SurfaceToolDictionary
...
func _assert_not_null_SurfaceTool(value: SurfaceTool):
    if (!value is SurfaceTool):
        _crash("Was expecting type 'SurfaceTool'")
