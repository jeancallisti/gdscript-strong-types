...
# where keys are of type 'String' and values of type 'PrimitiveMesh'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PrimitiveMeshDictionary
...
func _assert_not_null_PrimitiveMesh(value: PrimitiveMesh):
    if (!value is PrimitiveMesh):
        _crash("Was expecting type 'PrimitiveMesh'")
