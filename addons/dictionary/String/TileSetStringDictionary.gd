...
# where keys are of type 'String' and values of type 'TileSet'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TileSetDictionary
...
func _assert_not_null_TileSet(value: TileSet):
    if (!value is TileSet):
        _crash("Was expecting type 'TileSet'")
