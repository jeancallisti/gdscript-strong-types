...
# where keys are of type 'String' and values of type 'Tweener'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TweenerDictionary
...
func _assert_not_null_Tweener(value: Tweener):
    if (!value is Tweener):
        _crash("Was expecting type 'Tweener'")
