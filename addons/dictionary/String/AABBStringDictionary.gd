...
# where keys are of type 'String' and values of type 'AABB'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AABBDictionary
...
func _assert_not_null_AABB(value: AABB):
    if (!value is AABB):
        _crash("Was expecting type 'AABB'")
