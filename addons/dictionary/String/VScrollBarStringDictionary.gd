...
# where keys are of type 'String' and values of type 'VScrollBar'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VScrollBarDictionary
...
func _assert_not_null_VScrollBar(value: VScrollBar):
    if (!value is VScrollBar):
        _crash("Was expecting type 'VScrollBar'")
