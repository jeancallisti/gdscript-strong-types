...
# where keys are of type 'String' and values of type 'EditorSpinSlider'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name EditorSpinSliderDictionary
...
func _assert_not_null_EditorSpinSlider(value: EditorSpinSlider):
    if (!value is EditorSpinSlider):
        _crash("Was expecting type 'EditorSpinSlider'")
