...
# where keys are of type 'String' and values of type 'ToolButton'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ToolButtonDictionary
...
func _assert_not_null_ToolButton(value: ToolButton):
    if (!value is ToolButton):
        _crash("Was expecting type 'ToolButton'")
