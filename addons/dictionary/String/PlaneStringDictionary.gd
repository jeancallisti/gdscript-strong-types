...
# where keys are of type 'String' and values of type 'Plane'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PlaneDictionary
...
func _assert_not_null_Plane(value: Plane):
    if (!value is Plane):
        _crash("Was expecting type 'Plane'")
