...
# where keys are of type 'String' and values of type 'TextureArray'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TextureArrayDictionary
...
func _assert_not_null_TextureArray(value: TextureArray):
    if (!value is TextureArray):
        _crash("Was expecting type 'TextureArray'")
