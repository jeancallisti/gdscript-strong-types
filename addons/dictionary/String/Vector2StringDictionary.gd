...
# where keys are of type 'String' and values of type 'Vector2'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Vector2Dictionary
...
func _assert_not_null_Vector2(value: Vector2):
    if (!value is Vector2):
        _crash("Was expecting type 'Vector2'")
