...
# where keys are of type 'String' and values of type 'StreamTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name StreamTextureDictionary
...
func _assert_not_null_StreamTexture(value: StreamTexture):
    if (!value is StreamTexture):
        _crash("Was expecting type 'StreamTexture'")
