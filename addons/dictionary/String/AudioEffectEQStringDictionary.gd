...
# where keys are of type 'String' and values of type 'AudioEffectEQ'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AudioEffectEQDictionary
...
func _assert_not_null_AudioEffectEQ(value: AudioEffectEQ):
    if (!value is AudioEffectEQ):
        _crash("Was expecting type 'AudioEffectEQ'")
