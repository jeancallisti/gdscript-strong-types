...
# where keys are of type 'String' and values of type 'Color'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ColorDictionary
...
func _assert_not_null_Color(value: Color):
    if (!value is Color):
        _crash("Was expecting type 'Color'")
