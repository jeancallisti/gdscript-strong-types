...
# where keys are of type 'String' and values of type 'VisualShader'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualShaderDictionary
...
func _assert_not_null_VisualShader(value: VisualShader):
    if (!value is VisualShader):
        _crash("Was expecting type 'VisualShader'")
