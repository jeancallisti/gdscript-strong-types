...
# where keys are of type 'String' and values of type 'BoxContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BoxContainerDictionary
...
func _assert_not_null_BoxContainer(value: BoxContainer):
    if (!value is BoxContainer):
        _crash("Was expecting type 'BoxContainer'")
