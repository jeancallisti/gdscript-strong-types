...
# where keys are of type 'String' and values of type 'ReferenceRect'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ReferenceRectDictionary
...
func _assert_not_null_ReferenceRect(value: ReferenceRect):
    if (!value is ReferenceRect):
        _crash("Was expecting type 'ReferenceRect'")
