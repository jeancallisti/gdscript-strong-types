...
# where keys are of type 'String' and values of type 'AnimatedTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AnimatedTextureDictionary
...
func _assert_not_null_AnimatedTexture(value: AnimatedTexture):
    if (!value is AnimatedTexture):
        _crash("Was expecting type 'AnimatedTexture'")
