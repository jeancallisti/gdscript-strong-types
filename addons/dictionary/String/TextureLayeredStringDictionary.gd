...
# where keys are of type 'String' and values of type 'TextureLayered'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TextureLayeredDictionary
...
func _assert_not_null_TextureLayered(value: TextureLayered):
    if (!value is TextureLayered):
        _crash("Was expecting type 'TextureLayered'")
