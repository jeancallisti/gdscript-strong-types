...
# where keys are of type 'String' and values of type 'Object'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ObjectDictionary
...
func _assert_not_null_Object(value: Object):
    if (!value is Object):
        _crash("Was expecting type 'Object'")
...
func set_nullable(key: String, value: Object):
    _assert_not_null_String(key)
