...
# where keys are of type 'String' and values of type 'Reference'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ReferenceDictionary
...
func _assert_not_null_Reference(value: Reference):
    if (!value is Reference):
        _crash("Was expecting type 'Reference'")
