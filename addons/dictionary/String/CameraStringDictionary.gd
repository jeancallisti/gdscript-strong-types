...
# where keys are of type 'String' and values of type 'Camera'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CameraDictionary
...
func _assert_not_null_Camera(value: Camera):
    if (!value is Camera):
        _crash("Was expecting type 'Camera'")
