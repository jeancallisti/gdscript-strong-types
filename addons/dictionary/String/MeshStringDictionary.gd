...
# where keys are of type 'String' and values of type 'Mesh'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MeshDictionary
...
func _assert_not_null_Mesh(value: Mesh):
    if (!value is Mesh):
        _crash("Was expecting type 'Mesh'")
