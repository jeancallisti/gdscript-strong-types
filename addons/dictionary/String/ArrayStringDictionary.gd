...
# where keys are of type 'String' and values of type 'Array'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ArrayDictionary
...
func _assert_not_null_Array(value: Array):
    if (!value is Array):
        _crash("Was expecting type 'Array'")
