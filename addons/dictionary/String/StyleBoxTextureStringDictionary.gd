...
# where keys are of type 'String' and values of type 'StyleBoxTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name StyleBoxTextureDictionary
...
func _assert_not_null_StyleBoxTexture(value: StyleBoxTexture):
    if (!value is StyleBoxTexture):
        _crash("Was expecting type 'StyleBoxTexture'")
