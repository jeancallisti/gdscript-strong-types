...
# where keys are of type 'String' and values of type 'Skin'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SkinDictionary
...
func _assert_not_null_Skin(value: Skin):
    if (!value is Skin):
        _crash("Was expecting type 'Skin'")
