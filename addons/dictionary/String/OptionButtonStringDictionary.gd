...
# where keys are of type 'String' and values of type 'OptionButton'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name OptionButtonDictionary
...
func _assert_not_null_OptionButton(value: OptionButton):
    if (!value is OptionButton):
        _crash("Was expecting type 'OptionButton'")
