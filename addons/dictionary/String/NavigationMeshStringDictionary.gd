...
# where keys are of type 'String' and values of type 'NavigationMesh'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name NavigationMeshDictionary
...
func _assert_not_null_NavigationMesh(value: NavigationMesh):
    if (!value is NavigationMesh):
        _crash("Was expecting type 'NavigationMesh'")
