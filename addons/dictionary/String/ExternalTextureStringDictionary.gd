...
# where keys are of type 'String' and values of type 'ExternalTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ExternalTextureDictionary
...
func _assert_not_null_ExternalTexture(value: ExternalTexture):
    if (!value is ExternalTexture):
        _crash("Was expecting type 'ExternalTexture'")
