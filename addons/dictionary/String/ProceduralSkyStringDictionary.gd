...
# where keys are of type 'String' and values of type 'ProceduralSky'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ProceduralSkyDictionary
...
func _assert_not_null_ProceduralSky(value: ProceduralSky):
    if (!value is ProceduralSky):
        _crash("Was expecting type 'ProceduralSky'")
