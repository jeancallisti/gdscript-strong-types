...
# where keys are of type 'String' and values of type 'Time'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TimeDictionary
...
func _assert_not_null_Time(value: Time):
    if (!value is Time):
        _crash("Was expecting type 'Time'")
