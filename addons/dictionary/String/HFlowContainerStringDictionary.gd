...
# where keys are of type 'String' and values of type 'HFlowContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name HFlowContainerDictionary
...
func _assert_not_null_HFlowContainer(value: HFlowContainer):
    if (!value is HFlowContainer):
        _crash("Was expecting type 'HFlowContainer'")
