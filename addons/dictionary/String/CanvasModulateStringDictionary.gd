...
# where keys are of type 'String' and values of type 'CanvasModulate'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CanvasModulateDictionary
...
func _assert_not_null_CanvasModulate(value: CanvasModulate):
    if (!value is CanvasModulate):
        _crash("Was expecting type 'CanvasModulate'")
