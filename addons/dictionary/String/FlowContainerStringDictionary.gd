...
# where keys are of type 'String' and values of type 'FlowContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name FlowContainerDictionary
...
func _assert_not_null_FlowContainer(value: FlowContainer):
    if (!value is FlowContainer):
        _crash("Was expecting type 'FlowContainer'")
