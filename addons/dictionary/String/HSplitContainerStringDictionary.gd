...
# where keys are of type 'String' and values of type 'HSplitContainer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name HSplitContainerDictionary
...
func _assert_not_null_HSplitContainer(value: HSplitContainer):
    if (!value is HSplitContainer):
        _crash("Was expecting type 'HSplitContainer'")
