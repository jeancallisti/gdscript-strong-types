...
# where keys are of type 'String' and values of type 'VisualShaderNodeScalarOp'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualShaderNodeScalarOpDictionary
...
func _assert_not_null_VisualShaderNodeScalarOp(value: VisualShaderNodeScalarOp):
    if (!value is VisualShaderNodeScalarOp):
        _crash("Was expecting type 'VisualShaderNodeScalarOp'")
