...
# where keys are of type 'String' and values of type 'VisualScript'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualScriptDictionary
...
func _assert_not_null_VisualScript(value: VisualScript):
    if (!value is VisualScript):
        _crash("Was expecting type 'VisualScript'")
