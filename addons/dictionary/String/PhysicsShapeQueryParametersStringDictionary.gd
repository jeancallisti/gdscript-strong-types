...
# where keys are of type 'String' and values of type 'PhysicsShapeQueryParameters'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PhysicsShapeQueryParametersDictionary
...
func _assert_not_null_PhysicsShapeQueryParameters(value: PhysicsShapeQueryParameters):
    if (!value is PhysicsShapeQueryParameters):
        _crash("Was expecting type 'PhysicsShapeQueryParameters'")
...
func set(key: String, value: PhysicsShapeQueryParameters):
    _assert_not_null_String(key)
    _assert_not_null_PhysicsShapeQueryParameters(value)
    d[key] = value

# same as set but allows null values
func set_nullable(key: String, value: PhysicsShapeQueryParameters):
    _assert_not_null_String(key)
    _assert_nullable_PhysicsShapeQueryParameters(value)
    d[key] = value

func get(key: String) -> PhysicsShapeQueryParameters:
    _assert_not_null_String(key)
    return d[key]	
