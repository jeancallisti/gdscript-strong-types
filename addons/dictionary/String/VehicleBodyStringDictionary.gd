...
# where keys are of type 'String' and values of type 'VehicleBody'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VehicleBodyDictionary
...
func _assert_not_null_VehicleBody(value: VehicleBody):
    if (!value is VehicleBody):
        _crash("Was expecting type 'VehicleBody'")
