...
# where keys are of type 'String' and values of type 'CollisionShape'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CollisionShapeDictionary
...
func _assert_not_null_CollisionShape(value: CollisionShape):
    if (!value is CollisionShape):
        _crash("Was expecting type 'CollisionShape'")
