...
# where keys are of type 'String' and values of type 'MenuButton'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MenuButtonDictionary
...
func _assert_not_null_MenuButton(value: MenuButton):
    if (!value is MenuButton):
        _crash("Was expecting type 'MenuButton'")
