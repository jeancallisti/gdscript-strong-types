...
# where keys are of type 'String' and values of type 'BoneAttachment'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BoneAttachmentDictionary
...
func _assert_not_null_BoneAttachment(value: BoneAttachment):
    if (!value is BoneAttachment):
        _crash("Was expecting type 'BoneAttachment'")
