...
# where keys are of type 'String' and values of type 'HingeJoint'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name HingeJointDictionary
...
func _assert_not_null_HingeJoint(value: HingeJoint):
    if (!value is HingeJoint):
        _crash("Was expecting type 'HingeJoint'")
