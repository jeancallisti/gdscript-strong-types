...
# where keys are of type 'String' and values of type 'PoolIntArray'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PoolIntArrayDictionary
...
func _assert_not_null_PoolIntArray(value: PoolIntArray):
    if (!value is PoolIntArray):
        _crash("Was expecting type 'PoolIntArray'")
