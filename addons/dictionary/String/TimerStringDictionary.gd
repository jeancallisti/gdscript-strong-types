...
# where keys are of type 'String' and values of type 'Timer'.
...
func _assert_not_null_Timer(value: Timer):
    if (!value is Timer):
        _crash("Was expecting type 'Timer'")
