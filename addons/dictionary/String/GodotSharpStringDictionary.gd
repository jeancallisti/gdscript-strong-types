...
# where keys are of type 'String' and values of type 'GodotSharp'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name GodotSharpDictionary
...
func _assert_not_null_GodotSharp(value: GodotSharp):
    if (!value is GodotSharp):
        _crash("Was expecting type 'GodotSharp'")
