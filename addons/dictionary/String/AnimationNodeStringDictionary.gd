...
# where keys are of type 'String' and values of type 'AnimationNode'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AnimationNodeDictionary
...
func _assert_not_null_AnimationNode(value: AnimationNode):
    if (!value is AnimationNode):
        _crash("Was expecting type 'AnimationNode'")
