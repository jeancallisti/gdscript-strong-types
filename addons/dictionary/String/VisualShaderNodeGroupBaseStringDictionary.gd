...
# where keys are of type 'String' and values of type 'VisualShaderNodeGroupBase'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualShaderNodeGroupBaseDictionary
...
func _assert_not_null_VisualShaderNodeGroupBase(value: VisualShaderNodeGroupBase):
    if (!value is VisualShaderNodeGroupBase):
        _crash("Was expecting type 'VisualShaderNodeGroupBase'")
