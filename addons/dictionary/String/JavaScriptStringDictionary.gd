...
# where keys are of type 'String' and values of type 'JavaScript'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name JavaScriptDictionary
...
func _assert_not_null_JavaScript(value: JavaScript):
    if (!value is JavaScript):
        _crash("Was expecting type 'JavaScript'")
