...
# where keys are of type 'String' and values of type 'Spatial'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SpatialDictionary
...
func _assert_not_null_Spatial(value: Spatial):
    if (!value is Spatial):
        _crash("Was expecting type 'Spatial'")
