...
# where keys are of type 'String' and values of type 'CanvasLayer'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name CanvasLayerDictionary
...
func _assert_not_null_CanvasLayer(value: CanvasLayer):
    if (!value is CanvasLayer):
        _crash("Was expecting type 'CanvasLayer'")
