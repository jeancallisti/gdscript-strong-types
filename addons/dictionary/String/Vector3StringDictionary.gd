...
# where keys are of type 'String' and values of type 'Vector3'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Vector3Dictionary
...
func _assert_not_null_Vector3(value: Vector3):
    if (!value is Vector3):
        _crash("Was expecting type 'Vector3'")
