...
# where keys are of type 'String' and values of type 'RigidBody'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name RigidBodyDictionary
...
func _assert_not_null_RigidBody(value: RigidBody):
    if (!value is RigidBody):
        _crash("Was expecting type 'RigidBody'")
