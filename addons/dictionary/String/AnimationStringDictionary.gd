...
# where keys are of type 'String' and values of type 'Animation'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AnimationDictionary
...
func _assert_not_null_Animation(value: Animation):
    if (!value is Animation):
        _crash("Was expecting type 'Animation'")
