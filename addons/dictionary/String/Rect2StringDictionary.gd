...
# where keys are of type 'String' and values of type 'Rect2'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Rect2Dictionary
...
func _assert_not_null_Rect2(value: Rect2):
    if (!value is Rect2):
        _crash("Was expecting type 'Rect2'")
