...
# where keys are of type 'String' and values of type 'BitmapFont'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BitmapFontDictionary
...
func _assert_not_null_BitmapFont(value: BitmapFont):
    if (!value is BitmapFont):
        _crash("Was expecting type 'BitmapFont'")
