...
# where keys are of type 'String' and values of type 'PopupDialog'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PopupDialogDictionary
...
func _assert_not_null_PopupDialog(value: PopupDialog):
    if (!value is PopupDialog):
        _crash("Was expecting type 'PopupDialog'")
