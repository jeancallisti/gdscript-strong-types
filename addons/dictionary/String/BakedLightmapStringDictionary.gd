...
# where keys are of type 'String' and values of type 'BakedLightmap'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BakedLightmapDictionary
...
func _assert_not_null_BakedLightmap(value: BakedLightmap):
    if (!value is BakedLightmap):
        _crash("Was expecting type 'BakedLightmap'")
