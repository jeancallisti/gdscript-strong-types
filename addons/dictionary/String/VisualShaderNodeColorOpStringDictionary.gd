...
# where keys are of type 'String' and values of type 'VisualShaderNodeColorOp'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VisualShaderNodeColorOpDictionary
...
func _assert_not_null_VisualShaderNodeColorOp(value: VisualShaderNodeColorOp):
    if (!value is VisualShaderNodeColorOp):
        _crash("Was expecting type 'VisualShaderNodeColorOp'")
