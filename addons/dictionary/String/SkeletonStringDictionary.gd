...
# where keys are of type 'String' and values of type 'Skeleton'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SkeletonDictionary
...
func _assert_not_null_Skeleton(value: Skeleton):
    if (!value is Skeleton):
        _crash("Was expecting type 'Skeleton'")
