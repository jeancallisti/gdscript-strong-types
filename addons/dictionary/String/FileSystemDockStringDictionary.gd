...
# where keys are of type 'String' and values of type 'FileSystemDock'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name FileSystemDockDictionary
...
func _assert_not_null_FileSystemDock(value: FileSystemDock):
    if (!value is FileSystemDock):
        _crash("Was expecting type 'FileSystemDock'")
