...
# where keys are of type 'String' and values of type 'NetworkedMultiplayerCustom'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name NetworkedMultiplayerCustomDictionary
...
func _assert_not_null_NetworkedMultiplayerCustom(value: NetworkedMultiplayerCustom):
    if (!value is NetworkedMultiplayerCustom):
        _crash("Was expecting type 'NetworkedMultiplayerCustom'")
...
func set(key: String, value: NetworkedMultiplayerCustom):
    _assert_not_null_String(key)
    _assert_not_null_NetworkedMultiplayerCustom(value)
    d[key] = value

# same as set but allows null values
func set_nullable(key: String, value: NetworkedMultiplayerCustom):
    _assert_not_null_String(key)
    _assert_nullable_NetworkedMultiplayerCustom(value)
    d[key] = value

func get(key: String) -> NetworkedMultiplayerCustom:
    _assert_not_null_String(key)
    return d[key]	
