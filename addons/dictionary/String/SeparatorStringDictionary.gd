...
# where keys are of type 'String' and values of type 'Separator'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SeparatorDictionary
...
func _assert_not_null_Separator(value: Separator):
    if (!value is Separator):
        _crash("Was expecting type 'Separator'")
