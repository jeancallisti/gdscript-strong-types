...
# where keys are of type 'String' and values of type 'AtlasTexture'.
# It is not meant to be attached to a Node (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AtlasTextureDictionary
...
func _assert_not_null_AtlasTexture(value: AtlasTexture):
    if (!value is AtlasTexture):
        _crash("Was expecting type 'AtlasTexture'")
