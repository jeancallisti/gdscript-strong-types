...
# It is not meant to be attached to a DirAccess (unless you want to!)
...
func _assert_nullable_DirAccess(value: DirAccess):
    if (value == null):
        return
...
func _assert_all_nullable_DirAccess(values: Array):
    for v in values:
        _assert_nullable_DirAccess(v)

func _assert_all_not_null_DirAccess(values: Array):
    for v in values:
        _assert_not_null_DirAccess(v)
...
func set_at_nullable(position: int, value: DirAccess):
    _assert_nullable_DirAccess(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_DirAccess(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_DirAccess(array);
    a.append_array(array);
...
func count(value: DirAccess) -> int:
    _assert_not_null_DirAccess(value);
    return a.count(value);

func count_nullable(value: DirAccess) -> int:
    _assert_nullable_DirAccess(value);
    return a.count(value);
...
func erase(value: DirAccess):
    _assert_not_null_DirAccess(value);
    a.erase(value);

func erase_nullable(value: DirAccess):
    _assert_nullable_DirAccess(value);
    a.erase(value);

# TODO
# func fill(value: DirAccess)

func find(value: DirAccess) -> int:
    _assert_not_null_DirAccess(value);
    return a.find(value);

func find_nullable(value: DirAccess) -> int:
    _assert_nullable_DirAccess(value);
    return a.find(value);

#TODO
# func find_last(value: DirAccess)

# Returns the first element or crashes if empty
func front() -> DirAccess:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> DirAccess:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> DirAccess:
    if (a.empty()):
        return null;
    return a.front();

func has(value: DirAccess) -> bool:
    _assert_not_null_DirAccess(value);
    return a.has(value);

func has_nullable(value: DirAccess) -> bool:
    _assert_nullable_DirAccess(value);
    return a.has(value);
...
func insert(position: int, value: DirAccess):
    _assert_not_null_DirAccess(value);
    a.insert(position, value);

func insert_nullable(position: int, value: DirAccess):
    _assert_not_null_DirAccess(value);
    a.insert(position, value);
...
func pop_back() -> DirAccess:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: DirAccess = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> DirAccess:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> DirAccess:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: DirAccess = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> DirAccess:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: DirAccess):
    _assert_not_null_DirAccess(value);
    a.push_back(value);

func push_back_nullable(value: DirAccess):
    _assert_nullable_DirAccess(value);
    a.push_back(value);


func push_front(value: DirAccess):
    _assert_not_null_DirAccess(value);
    a.push_front(value);

func push_front_nullable(value: DirAccess):
    _assert_nullable_DirAccess(value);
    a.push_back(value);
