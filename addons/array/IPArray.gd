...
# It is not meant to be attached to a IP (unless you want to!)
...
func _assert_nullable_IP(value: IP):
    if (value == null):
        return
...
func _assert_all_nullable_IP(values: Array):
    for v in values:
        _assert_nullable_IP(v)

func _assert_all_not_null_IP(values: Array):
    for v in values:
        _assert_not_null_IP(v)
...
func append_array(array: Array):
    _assert_all_not_null_IP(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_IP(array);
    a.append_array(array);
...
func count(value: IP) -> int:
    _assert_not_null_IP(value);
    return a.count(value);

func count_nullable(value: IP) -> int:
    _assert_nullable_IP(value);
    return a.count(value);
...
func find(value: IP) -> int:
    _assert_not_null_IP(value);
    return a.find(value);

func find_nullable(value: IP) -> int:
    _assert_nullable_IP(value);
    return a.find(value);

#TODO
# func find_last(value: IP)
...
func first_or_default() -> IP:
    if (a.empty()):
        return null;
    return a.front();

func has(value: IP) -> bool:
    _assert_not_null_IP(value);
    return a.has(value);

func has_nullable(value: IP) -> bool:
    _assert_nullable_IP(value);
    return a.has(value);
...
func insert(position: int, value: IP):
    _assert_not_null_IP(value);
    a.insert(position, value);

func insert_nullable(position: int, value: IP):
    _assert_not_null_IP(value);
    a.insert(position, value);
...
func pop_at(position: int) -> IP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: IP = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> IP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> IP:
    ...
    var result: IP = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> IP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> IP:
    ...
    var result: IP = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> IP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: IP):
    _assert_not_null_IP(value);
    a.push_back(value);

func push_back_nullable(value: IP):
    _assert_nullable_IP(value);
    a.push_back(value);


func push_front(value: IP):
    _assert_not_null_IP(value);
    a.push_front(value);

func push_front_nullable(value: IP):
    _assert_nullable_IP(value);
    a.push_back(value);
