...
# in which the values are of type 'Basis'.
# It is not meant to be attached to a Basis (unless you want to!)
# You can generate more classes like this one for your own types.
class_name BasisArray
...
func _assert_nullable_Basis(value: Basis):
    if (value == null):
        return

    if (!(value is Basis)):
        _crash("value was expected to be of type Basis")

func _assert_not_null_Basis(value: Basis):
    if (!(value is Basis)):
        _crash("value was expected to be of type Basis")

func _assert_all_nullable_Basis(values: Array):
    for v in values:
        _assert_nullable_Basis(v)

func _assert_all_not_null_Basis(values: Array):
    for v in values:
        _assert_not_null_Basis(v)

func set_at(position: int, value: Basis):
    _assert_not_null_Basis(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Basis):
    _assert_nullable_Basis(value);
    a[position] = value;

func get_at(position: int) -> Basis:
    return a[position];

func add(value: Basis):
    _assert_not_null_Basis(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Basis):
    _assert_nullable_Basis(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Basis):
    _assert_not_null_Basis(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Basis):
    _assert_nullable_Basis(value);
    a.append(value);
...
# func Contains(value: Basis) -> bool:
#     _assert_Basis(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Basis(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Basis(array);
    a.append_array(array);
...
func count(value: Basis) -> int:
    _assert_not_null_Basis(value);
    return a.count(value);

func count_nullable(value: Basis) -> int:
    _assert_nullable_Basis(value);
    return a.count(value);
...
func erase(value: Basis):
    _assert_not_null_Basis(value);
    a.erase(value);

func erase_nullable(value: Basis):
    _assert_nullable_Basis(value);
    a.erase(value);

# TODO
# func fill(value: Basis)

func find(value: Basis) -> int:
    _assert_not_null_Basis(value);
    return a.find(value);

func find_nullable(value: Basis) -> int:
    _assert_nullable_Basis(value);
    return a.find(value);

#TODO
# func find_last(value: Basis)
...
func first_or_default() -> Basis:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Basis) -> bool:
    _assert_not_null_Basis(value);
    return a.has(value);

func has_nullable(value: Basis) -> bool:
    _assert_nullable_Basis(value);
    return a.has(value);
...
func insert(position: int, value: Basis):
    _assert_not_null_Basis(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Basis):
    _assert_not_null_Basis(value);
    a.insert(position, value);
...
func pop_back() -> Basis:
    ...
    var result: Basis = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Basis:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Basis:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Basis = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Basis:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Basis):
    _assert_not_null_Basis(value);
    a.push_back(value);

func push_back_nullable(value: Basis):
    _assert_nullable_Basis(value);
    a.push_back(value);


func push_front(value: Basis):
    _assert_not_null_Basis(value);
    a.push_front(value);

func push_front_nullable(value: Basis):
    _assert_nullable_Basis(value);
    a.push_back(value);
