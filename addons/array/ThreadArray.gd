...
# in which the values are of type 'Thread'.
# It is not meant to be attached to a Thread (unless you want to!)
...
func _assert_nullable_Thread(value: Thread):
    if (value == null):
        return
...
func _assert_all_nullable_Thread(values: Array):
    for v in values:
        _assert_nullable_Thread(v)

func _assert_all_not_null_Thread(values: Array):
    for v in values:
        _assert_not_null_Thread(v)

func set_at(position: int, value: Thread):
    _assert_not_null_Thread(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Thread):
    _assert_nullable_Thread(value);
    a[position] = value;
...
func add_nullable(value: Thread):
    _assert_nullable_Thread(value);
    a.append(value);
...
func append_nullable(value: Thread):
    _assert_nullable_Thread(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_Thread(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Thread(array);
    a.append_array(array);
...
func count(value: Thread) -> int:
    _assert_not_null_Thread(value);
    return a.count(value);

func count_nullable(value: Thread) -> int:
    _assert_nullable_Thread(value);
    return a.count(value);
...
func erase(value: Thread):
    _assert_not_null_Thread(value);
    a.erase(value);

func erase_nullable(value: Thread):
    _assert_nullable_Thread(value);
    a.erase(value);

# TODO
# func fill(value: Thread)

func find(value: Thread) -> int:
    _assert_not_null_Thread(value);
    return a.find(value);

func find_nullable(value: Thread) -> int:
    _assert_nullable_Thread(value);
    return a.find(value);

#TODO
# func find_last(value: Thread)
...
func first_or_default() -> Thread:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Thread) -> bool:
    _assert_not_null_Thread(value);
    return a.has(value);

func has_nullable(value: Thread) -> bool:
    _assert_nullable_Thread(value);
    return a.has(value);
...
func insert(position: int, value: Thread):
    _assert_not_null_Thread(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Thread):
    _assert_not_null_Thread(value);
    a.insert(position, value);
...
func pop_back() -> Thread:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Thread = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Thread:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Thread:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Thread = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Thread:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Thread):
    _assert_not_null_Thread(value);
    a.push_back(value);

func push_back_nullable(value: Thread):
    _assert_nullable_Thread(value);
    a.push_back(value);


func push_front(value: Thread):
    _assert_not_null_Thread(value);
    a.push_front(value);

func push_front_nullable(value: Thread):
    _assert_nullable_Thread(value);
    a.push_back(value);
