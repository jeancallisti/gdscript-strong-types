...
# It is not meant to be attached to a AStarGrid2D (unless you want to!)
...
func _assert_all_nullable_AStarGrid2D(values: Array):
    for v in values:
        _assert_nullable_AStarGrid2D(v)

func _assert_all_not_null_AStarGrid2D(values: Array):
    for v in values:
        _assert_not_null_AStarGrid2D(v)
...
func append_array(array: Array):
    _assert_all_not_null_AStarGrid2D(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_AStarGrid2D(array);
    a.append_array(array);

func back() -> AStarGrid2D:
    return a.back();
...
func count(value: AStarGrid2D) -> int:
    _assert_not_null_AStarGrid2D(value);
    return a.count(value);

func count_nullable(value: AStarGrid2D) -> int:
    _assert_nullable_AStarGrid2D(value);
    return a.count(value);
...
func erase(value: AStarGrid2D):
    _assert_not_null_AStarGrid2D(value);
    a.erase(value);

func erase_nullable(value: AStarGrid2D):
    _assert_nullable_AStarGrid2D(value);
    a.erase(value);

# TODO
# func fill(value: AStarGrid2D)

func find(value: AStarGrid2D) -> int:
    _assert_not_null_AStarGrid2D(value);
    return a.find(value);

func find_nullable(value: AStarGrid2D) -> int:
    _assert_nullable_AStarGrid2D(value);
    return a.find(value);

#TODO
# func find_last(value: AStarGrid2D)

# Returns the first element or crashes if empty
func front() -> AStarGrid2D:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> AStarGrid2D:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> AStarGrid2D:
    if (a.empty()):
        return null;
    return a.front();

func has(value: AStarGrid2D) -> bool:
    _assert_not_null_AStarGrid2D(value);
    return a.has(value);

func has_nullable(value: AStarGrid2D) -> bool:
    _assert_nullable_AStarGrid2D(value);
    return a.has(value);
...
func insert(position: int, value: AStarGrid2D):
    _assert_not_null_AStarGrid2D(value);
    a.insert(position, value);

func insert_nullable(position: int, value: AStarGrid2D):
    _assert_not_null_AStarGrid2D(value);
    a.insert(position, value);
...
func max() -> AStarGrid2D:
    var result: AStarGrid2D = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> AStarGrid2D:
    var result: AStarGrid2D = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStarGrid2D = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStarGrid2D = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStarGrid2D = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> AStarGrid2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: AStarGrid2D):
    _assert_not_null_AStarGrid2D(value);
    a.push_back(value);

func push_back_nullable(value: AStarGrid2D):
    _assert_nullable_AStarGrid2D(value);
    a.push_back(value);


func push_front(value: AStarGrid2D):
    _assert_not_null_AStarGrid2D(value);
    a.push_front(value);

func push_front_nullable(value: AStarGrid2D):
    _assert_nullable_AStarGrid2D(value);
    a.push_back(value);
