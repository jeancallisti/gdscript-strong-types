...
# in which the values are of type 'AABB'.
# It is not meant to be attached to a AABB (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AABBArray
...
func _assert_nullable_AABB(value: AABB):
    if (value == null):
        return

    if (!(value is AABB)):
        _crash("value was expected to be of type AABB")

func _assert_not_null_AABB(value: AABB):
    if (!(value is AABB)):
        _crash("value was expected to be of type AABB")

func _assert_all_nullable_AABB(values: Array):
    for v in values:
        _assert_nullable_AABB(v)

func _assert_all_not_null_AABB(values: Array):
    for v in values:
        _assert_not_null_AABB(v)

func set_at(position: int, value: AABB):
    _assert_not_null_AABB(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: AABB):
    _assert_nullable_AABB(value);
    a[position] = value;

func get_at(position: int) -> AABB:
    return a[position];
...
func add_nullable(value: AABB):
    _assert_nullable_AABB(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: AABB):
    _assert_not_null_AABB(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: AABB):
    _assert_nullable_AABB(value);
    a.append(value);
...
# func Contains(value: AABB) -> bool:
#     _assert_AABB(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_AABB(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_AABB(array);
    a.append_array(array);
...
func count(value: AABB) -> int:
    _assert_not_null_AABB(value);
    return a.count(value);

func count_nullable(value: AABB) -> int:
    _assert_nullable_AABB(value);
    return a.count(value);
...
func erase(value: AABB):
    _assert_not_null_AABB(value);
    a.erase(value);

func erase_nullable(value: AABB):
    _assert_nullable_AABB(value);
    a.erase(value);

# TODO
# func fill(value: AABB)

func find(value: AABB) -> int:
    _assert_not_null_AABB(value);
    return a.find(value);

func find_nullable(value: AABB) -> int:
    _assert_nullable_AABB(value);
    return a.find(value);

#TODO
# func find_last(value: AABB)
...
func first_or_default() -> AABB:
    if (a.empty()):
        return null;
    return a.front();

func has(value: AABB) -> bool:
    _assert_not_null_AABB(value);
    return a.has(value);

func has_nullable(value: AABB) -> bool:
    _assert_nullable_AABB(value);
    return a.has(value);
...
func insert(position: int, value: AABB):
    _assert_not_null_AABB(value);
    a.insert(position, value);

func insert_nullable(position: int, value: AABB):
    _assert_not_null_AABB(value);
    a.insert(position, value);
...
func pop_back() -> AABB:
    ...
    var result: AABB = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> AABB:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> AABB:
    ...
    var result: AABB = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> AABB:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: AABB):
    _assert_not_null_AABB(value);
    a.push_back(value);

func push_back_nullable(value: AABB):
    _assert_nullable_AABB(value);
    a.push_back(value);


func push_front(value: AABB):
    _assert_not_null_AABB(value);
    a.push_front(value);

func push_front_nullable(value: AABB):
    _assert_nullable_AABB(value);
    a.push_back(value);
