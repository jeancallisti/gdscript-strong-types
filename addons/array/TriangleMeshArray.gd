...
# in which the values are of type 'TriangleMesh'.
# It is not meant to be attached to a TriangleMesh (unless you want to!)
...
func _assert_nullable_TriangleMesh(value: TriangleMesh):
    if (value == null):
        return
...
func _assert_all_nullable_TriangleMesh(values: Array):
    for v in values:
        _assert_nullable_TriangleMesh(v)

func _assert_all_not_null_TriangleMesh(values: Array):
    for v in values:
        _assert_not_null_TriangleMesh(v)

func set_at(position: int, value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a[position] = value;
...
func add_nullable(value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a.append(value);
...
func append_nullable(value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_TriangleMesh(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_TriangleMesh(array);
    a.append_array(array);

func back() -> TriangleMesh:
    return a.back();
...
func count(value: TriangleMesh) -> int:
    _assert_not_null_TriangleMesh(value);
    return a.count(value);

func count_nullable(value: TriangleMesh) -> int:
    _assert_nullable_TriangleMesh(value);
    return a.count(value);
...
func erase(value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a.erase(value);

func erase_nullable(value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a.erase(value);

# TODO
# func fill(value: TriangleMesh)

func find(value: TriangleMesh) -> int:
    _assert_not_null_TriangleMesh(value);
    return a.find(value);

func find_nullable(value: TriangleMesh) -> int:
    _assert_nullable_TriangleMesh(value);
    return a.find(value);

#TODO
# func find_last(value: TriangleMesh)

# Returns the first element or crashes if empty
func front() -> TriangleMesh:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> TriangleMesh:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> TriangleMesh:
    if (a.empty()):
        return null;
    return a.front();

func has(value: TriangleMesh) -> bool:
    _assert_not_null_TriangleMesh(value);
    return a.has(value);

func has_nullable(value: TriangleMesh) -> bool:
    _assert_nullable_TriangleMesh(value);
    return a.has(value);
...
func insert(position: int, value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a.insert(position, value);

func insert_nullable(position: int, value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a.insert(position, value);
...
func max() -> TriangleMesh:
    var result: TriangleMesh = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> TriangleMesh:
    var result: TriangleMesh = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: TriangleMesh = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: TriangleMesh = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: TriangleMesh = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> TriangleMesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a.push_back(value);

func push_back_nullable(value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a.push_back(value);


func push_front(value: TriangleMesh):
    _assert_not_null_TriangleMesh(value);
    a.push_front(value);

func push_front_nullable(value: TriangleMesh):
    _assert_nullable_TriangleMesh(value);
    a.push_back(value);
