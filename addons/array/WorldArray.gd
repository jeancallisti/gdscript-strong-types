...
# in which the values are of type 'World'.
# It is not meant to be attached to a World (unless you want to!)
# You can generate more classes like this one for your own types.
class_name WorldArray
...
func _assert_nullable_World(value: World):
    if (value == null):
        return

    if (!(value is World)):
        _crash("value was expected to be of type World")

func _assert_not_null_World(value: World):
    if (!(value is World)):
        _crash("value was expected to be of type World")

func _assert_all_nullable_World(values: Array):
    for v in values:
        _assert_nullable_World(v)

func _assert_all_not_null_World(values: Array):
    for v in values:
        _assert_not_null_World(v)

func set_at(position: int, value: World):
    _assert_not_null_World(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: World):
    _assert_nullable_World(value);
    a[position] = value;

func get_at(position: int) -> World:
    return a[position];

func add(value: World):
    _assert_not_null_World(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: World):
    _assert_nullable_World(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: World):
    _assert_not_null_World(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: World):
    _assert_nullable_World(value);
    a.append(value);
...
# func Contains(value: World) -> bool:
#     _assert_World(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_World(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_World(array);
    a.append_array(array);
...
func count(value: World) -> int:
    _assert_not_null_World(value);
    return a.count(value);

func count_nullable(value: World) -> int:
    _assert_nullable_World(value);
    return a.count(value);
...
func erase(value: World):
    _assert_not_null_World(value);
    a.erase(value);

func erase_nullable(value: World):
    _assert_nullable_World(value);
    a.erase(value);

# TODO
# func fill(value: World)

func find(value: World) -> int:
    _assert_not_null_World(value);
    return a.find(value);

func find_nullable(value: World) -> int:
    _assert_nullable_World(value);
    return a.find(value);

#TODO
# func find_last(value: World)
...
func first_or_default() -> World:
    if (a.empty()):
        return null;
    return a.front();

func has(value: World) -> bool:
    _assert_not_null_World(value);
    return a.has(value);

func has_nullable(value: World) -> bool:
    _assert_nullable_World(value);
    return a.has(value);
...
func insert(position: int, value: World):
    _assert_not_null_World(value);
    a.insert(position, value);

func insert_nullable(position: int, value: World):
    _assert_not_null_World(value);
    a.insert(position, value);
...
func pop_back() -> World:
    ...
    var result: World = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> World:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> World:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: World = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> World:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: World):
    _assert_not_null_World(value);
    a.push_back(value);

func push_back_nullable(value: World):
    _assert_nullable_World(value);
    a.push_back(value);


func push_front(value: World):
    _assert_not_null_World(value);
    a.push_front(value);

func push_front_nullable(value: World):
    _assert_nullable_World(value);
    a.push_back(value);
