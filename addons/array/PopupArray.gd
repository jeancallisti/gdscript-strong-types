...
# in which the values are of type 'Popup'.
# It is not meant to be attached to a Popup (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PopupArray
...
func _assert_nullable_Popup(value: Popup):
    if (value == null):
        return

    if (!(value is Popup)):
        _crash("value was expected to be of type Popup")

func _assert_not_null_Popup(value: Popup):
    if (!(value is Popup)):
        _crash("value was expected to be of type Popup")

func _assert_all_nullable_Popup(values: Array):
    for v in values:
        _assert_nullable_Popup(v)

func _assert_all_not_null_Popup(values: Array):
    for v in values:
        _assert_not_null_Popup(v)

func set_at(position: int, value: Popup):
    _assert_not_null_Popup(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Popup):
    _assert_nullable_Popup(value);
    a[position] = value;

func get_at(position: int) -> Popup:
    return a[position];

func add(value: Popup):
    _assert_not_null_Popup(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Popup):
    _assert_nullable_Popup(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Popup):
    _assert_not_null_Popup(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Popup):
    _assert_nullable_Popup(value);
    a.append(value);
...
# func Contains(value: Popup) -> bool:
#     _assert_Popup(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Popup(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Popup(array);
    a.append_array(array);
...
func count(value: Popup) -> int:
    _assert_not_null_Popup(value);
    return a.count(value);

func count_nullable(value: Popup) -> int:
    _assert_nullable_Popup(value);
    return a.count(value);
...
func erase(value: Popup):
    _assert_not_null_Popup(value);
    a.erase(value);

func erase_nullable(value: Popup):
    _assert_nullable_Popup(value);
    a.erase(value);

# TODO
# func fill(value: Popup)

func find(value: Popup) -> int:
    _assert_not_null_Popup(value);
    return a.find(value);

func find_nullable(value: Popup) -> int:
    _assert_nullable_Popup(value);
    return a.find(value);

#TODO
# func find_last(value: Popup)
...
func first_or_default() -> Popup:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Popup) -> bool:
    _assert_not_null_Popup(value);
    return a.has(value);

func has_nullable(value: Popup) -> bool:
    _assert_nullable_Popup(value);
    return a.has(value);
...
func insert(position: int, value: Popup):
    _assert_not_null_Popup(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Popup):
    _assert_not_null_Popup(value);
    a.insert(position, value);
...
func pop_back() -> Popup:
    ...
    var result: Popup = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Popup:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Popup:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Popup = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Popup:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Popup):
    _assert_not_null_Popup(value);
    a.push_back(value);

func push_back_nullable(value: Popup):
    _assert_nullable_Popup(value);
    a.push_back(value);


func push_front(value: Popup):
    _assert_not_null_Popup(value);
    a.push_front(value);

func push_front_nullable(value: Popup):
    _assert_nullable_Popup(value);
    a.push_back(value);
