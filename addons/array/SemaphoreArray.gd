...
# It is not meant to be attached to a Semaphore (unless you want to!)
...
func _assert_nullable_Semaphore(value: Semaphore):
    if (value == null):
        return
...
func _assert_all_nullable_Semaphore(values: Array):
    for v in values:
        _assert_nullable_Semaphore(v)

func _assert_all_not_null_Semaphore(values: Array):
    for v in values:
        _assert_not_null_Semaphore(v)
...
func set_at_nullable(position: int, value: Semaphore):
    _assert_nullable_Semaphore(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_Semaphore(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Semaphore(array);
    a.append_array(array);
...
func count(value: Semaphore) -> int:
    _assert_not_null_Semaphore(value);
    return a.count(value);

func count_nullable(value: Semaphore) -> int:
    _assert_nullable_Semaphore(value);
    return a.count(value);
...
func erase(value: Semaphore):
    _assert_not_null_Semaphore(value);
    a.erase(value);

func erase_nullable(value: Semaphore):
    _assert_nullable_Semaphore(value);
    a.erase(value);

# TODO
# func fill(value: Semaphore)

func find(value: Semaphore) -> int:
    _assert_not_null_Semaphore(value);
    return a.find(value);

func find_nullable(value: Semaphore) -> int:
    _assert_nullable_Semaphore(value);
    return a.find(value);

#TODO
# func find_last(value: Semaphore)

# Returns the first element or crashes if empty
func front() -> Semaphore:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> Semaphore:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> Semaphore:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Semaphore) -> bool:
    _assert_not_null_Semaphore(value);
    return a.has(value);

func has_nullable(value: Semaphore) -> bool:
    _assert_nullable_Semaphore(value);
    return a.has(value);
...
func insert(position: int, value: Semaphore):
    _assert_not_null_Semaphore(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Semaphore):
    _assert_not_null_Semaphore(value);
    a.insert(position, value);
...
func pop_back() -> Semaphore:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Semaphore = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Semaphore:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Semaphore:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Semaphore = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Semaphore:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Semaphore):
    _assert_not_null_Semaphore(value);
    a.push_back(value);

func push_back_nullable(value: Semaphore):
    _assert_nullable_Semaphore(value);
    a.push_back(value);


func push_front(value: Semaphore):
    _assert_not_null_Semaphore(value);
    a.push_front(value);

func push_front_nullable(value: Semaphore):
    _assert_nullable_Semaphore(value);
    a.push_back(value);
