...
# in which the values are of type 'float'.
# It is not meant to be attached to a float (unless you want to!)
# You can generate more classes like this one for your own types.
class_name floatArray
...
func _assert_nullable_float(value: float):
    if (value == null):
        return

    if (!(value is float)):
        _crash("value was expected to be of type float")

func _assert_not_null_float(value: float):
    if (!(value is float)):
        _crash("value was expected to be of type float")

func _assert_all_nullable_float(values: Array):
    for v in values:
        _assert_nullable_float(v)

func _assert_all_not_null_float(values: Array):
    for v in values:
        _assert_not_null_float(v)

func set_at(position: int, value: float):
    _assert_not_null_float(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: float):
    _assert_nullable_float(value);
    a[position] = value;

func get_at(position: int) -> float:
    return a[position];
...
func append_nullable(value: float):
    _assert_nullable_float(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_float(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_float(array);
    a.append_array(array);
...
func count_nullable(value: float) -> int:
    _assert_nullable_float(value);
    return a.count(value);
...
func erase(value: float):
    _assert_not_null_float(value);
    a.erase(value);

func erase_nullable(value: float):
    _assert_nullable_float(value);
    a.erase(value);
...
func find(value: float) -> int:
    _assert_not_null_float(value);
    return a.find(value);

func find_nullable(value: float) -> int:
    _assert_nullable_float(value);
    return a.find(value);

#TODO
# func find_last(value: float)
...
func has_nullable(value: float) -> bool:
    _assert_nullable_float(value);
    return a.has(value);
...
func insert(position: int, value: float):
    _assert_not_null_float(value);
    a.insert(position, value);

func insert_nullable(position: int, value: float):
    _assert_not_null_float(value);
    a.insert(position, value);
...
func pop_back() -> float:
    ...
    var result: float = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> float:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> float:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: float = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> float:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: float):
    _assert_not_null_float(value);
    a.push_back(value);

func push_back_nullable(value: float):
    _assert_nullable_float(value);
    a.push_back(value);


func push_front(value: float):
    _assert_not_null_float(value);
    a.push_front(value);

func push_front_nullable(value: float):
    _assert_nullable_float(value);
    a.push_back(value);
