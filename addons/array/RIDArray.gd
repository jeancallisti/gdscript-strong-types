...
# in which the values are of type 'RID'.
# It is not meant to be attached to a RID (unless you want to!)
...
func _assert_nullable_RID(value: RID):
    if (value == null):
        return

    if (!(value is RID)):
        _crash("value was expected to be of type RID")

func _assert_not_null_RID(value: RID):
    if (!(value is RID)):
        _crash("value was expected to be of type RID")

func _assert_all_nullable_RID(values: Array):
    for v in values:
        _assert_nullable_RID(v)

func _assert_all_not_null_RID(values: Array):
    for v in values:
        _assert_not_null_RID(v)

func set_at(position: int, value: RID):
    _assert_not_null_RID(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: RID):
    _assert_nullable_RID(value);
    a[position] = value;

func get_at(position: int) -> RID:
    return a[position];
...
func add_nullable(value: RID):
    _assert_nullable_RID(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: RID):
    _assert_not_null_RID(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: RID):
    _assert_nullable_RID(value);
    a.append(value);
...
func count(value: RID) -> int:
    _assert_not_null_RID(value);
    return a.count(value);

func count_nullable(value: RID) -> int:
    _assert_nullable_RID(value);
    return a.count(value);
...
func erase(value: RID):
    _assert_not_null_RID(value);
    a.erase(value);

func erase_nullable(value: RID):
    _assert_nullable_RID(value);
    a.erase(value);
...
func find(value: RID) -> int:
    _assert_not_null_RID(value);
    return a.find(value);

func find_nullable(value: RID) -> int:
    _assert_nullable_RID(value);
    return a.find(value);

#TODO
# func find_last(value: RID)
...
func first_or_default() -> RID:
    if (a.empty()):
        return null;
    return a.front();

func has(value: RID) -> bool:
    _assert_not_null_RID(value);
    return a.has(value);

func has_nullable(value: RID) -> bool:
    _assert_nullable_RID(value);
    return a.has(value);
...
func insert(position: int, value: RID):
    _assert_not_null_RID(value);
    a.insert(position, value);

func insert_nullable(position: int, value: RID):
    _assert_not_null_RID(value);
    a.insert(position, value);
...
func pop_back() -> RID:
    ...
    var result: RID = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> RID:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> RID:
    ...
    var result: RID = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> RID:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: RID):
    _assert_not_null_RID(value);
    a.push_back(value);

func push_back_nullable(value: RID):
    _assert_nullable_RID(value);
    a.push_back(value);


func push_front(value: RID):
    _assert_not_null_RID(value);
    a.push_front(value);

func push_front_nullable(value: RID):
    _assert_nullable_RID(value);
    a.push_back(value);
