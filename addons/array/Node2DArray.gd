...
# in which the values are of type 'Node2D'.
# It is not meant to be attached to a Node2D (unless you want to!)
...
func _assert_nullable_Node2D(value: Node2D):
    if (value == null):
        return

    if (!(value is Node2D)):
        _crash("value was expected to be of type Node2D")

func _assert_not_null_Node2D(value: Node2D):
    if (!(value is Node2D)):
        _crash("value was expected to be of type Node2D")

func _assert_all_nullable_Node2D(values: Array):
    for v in values:
        _assert_nullable_Node2D(v)

func _assert_all_not_null_Node2D(values: Array):
    for v in values:
        _assert_not_null_Node2D(v)

func set_at(position: int, value: Node2D):
    _assert_not_null_Node2D(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Node2D):
    _assert_nullable_Node2D(value);
    a[position] = value;

func get_at(position: int) -> Node2D:
    return a[position];
...
func add_nullable(value: Node2D):
    _assert_nullable_Node2D(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Node2D):
    _assert_not_null_Node2D(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Node2D):
    _assert_nullable_Node2D(value);
    a.append(value);
...
# func Contains(value: Node2D) -> bool:
#     _assert_Node2D(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Node2D(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Node2D(array);
    a.append_array(array);
...
func count(value: Node2D) -> int:
    _assert_not_null_Node2D(value);
    return a.count(value);

func count_nullable(value: Node2D) -> int:
    _assert_nullable_Node2D(value);
    return a.count(value);
...
func erase(value: Node2D):
    _assert_not_null_Node2D(value);
    a.erase(value);

func erase_nullable(value: Node2D):
    _assert_nullable_Node2D(value);
    a.erase(value);

# TODO
# func fill(value: Node2D)

func find(value: Node2D) -> int:
    _assert_not_null_Node2D(value);
    return a.find(value);

func find_nullable(value: Node2D) -> int:
    _assert_nullable_Node2D(value);
    return a.find(value);

#TODO
# func find_last(value: Node2D)
...
func first_or_default() -> Node2D:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Node2D) -> bool:
    _assert_not_null_Node2D(value);
    return a.has(value);

func has_nullable(value: Node2D) -> bool:
    _assert_nullable_Node2D(value);
    return a.has(value);
...
func insert(position: int, value: Node2D):
    _assert_not_null_Node2D(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Node2D):
    _assert_not_null_Node2D(value);
    a.insert(position, value);
...
func pop_back() -> Node2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Node2D = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Node2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Node2D:
    ...
    var result: Node2D = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Node2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Node2D):
    _assert_not_null_Node2D(value);
    a.push_back(value);

func push_back_nullable(value: Node2D):
    _assert_nullable_Node2D(value);
    a.push_back(value);


func push_front(value: Node2D):
    _assert_not_null_Node2D(value);
    a.push_front(value);

func push_front_nullable(value: Node2D):
    _assert_nullable_Node2D(value);
    a.push_back(value);
