...
# in which the values are of type 'Resource'.
# It is not meant to be attached to a Resource (unless you want to!)
...
func _assert_nullable_Resource(value: Resource):
    if (value == null):
        return
...
func _assert_all_nullable_Resource(values: Array):
    for v in values:
        _assert_nullable_Resource(v)

func _assert_all_not_null_Resource(values: Array):
    for v in values:
        _assert_not_null_Resource(v)

func set_at(position: int, value: Resource):
    _assert_not_null_Resource(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Resource):
    _assert_nullable_Resource(value);
    a[position] = value;
...
func add_nullable(value: Resource):
    _assert_nullable_Resource(value);
    a.append(value);
...
func append_nullable(value: Resource):
    _assert_nullable_Resource(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_Resource(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Resource(array);
    a.append_array(array);
...
func count(value: Resource) -> int:
    _assert_not_null_Resource(value);
    return a.count(value);

func count_nullable(value: Resource) -> int:
    _assert_nullable_Resource(value);
    return a.count(value);
...
func erase(value: Resource):
    _assert_not_null_Resource(value);
    a.erase(value);

func erase_nullable(value: Resource):
    _assert_nullable_Resource(value);
    a.erase(value);

# TODO
# func fill(value: Resource)

func find(value: Resource) -> int:
    _assert_not_null_Resource(value);
    return a.find(value);

func find_nullable(value: Resource) -> int:
    _assert_nullable_Resource(value);
    return a.find(value);

#TODO
# func find_last(value: Resource)
...
func first_or_default() -> Resource:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Resource) -> bool:
    _assert_not_null_Resource(value);
    return a.has(value);

func has_nullable(value: Resource) -> bool:
    _assert_nullable_Resource(value);
    return a.has(value);
...
func insert(position: int, value: Resource):
    _assert_not_null_Resource(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Resource):
    _assert_not_null_Resource(value);
    a.insert(position, value);
...
func pop_back() -> Resource:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Resource = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Resource:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Resource:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Resource = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Resource:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Resource):
    _assert_not_null_Resource(value);
    a.push_back(value);

func push_back_nullable(value: Resource):
    _assert_nullable_Resource(value);
    a.push_back(value);


func push_front(value: Resource):
    _assert_not_null_Resource(value);
    a.push_front(value);

func push_front_nullable(value: Resource):
    _assert_nullable_Resource(value);
    a.push_back(value);
