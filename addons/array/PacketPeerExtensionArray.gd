...
# It is not meant to be attached to a PacketPeerExtension (unless you want to!)
...
func _assert_nullable_PacketPeerExtension(value: PacketPeerExtension):
    if (value == null):
        return
...
func _assert_all_nullable_PacketPeerExtension(values: Array):
    for v in values:
        _assert_nullable_PacketPeerExtension(v)

func _assert_all_not_null_PacketPeerExtension(values: Array):
    for v in values:
        _assert_not_null_PacketPeerExtension(v)
...
func set_at_nullable(position: int, value: PacketPeerExtension):
    _assert_nullable_PacketPeerExtension(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_PacketPeerExtension(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_PacketPeerExtension(array);
    a.append_array(array);

func back() -> PacketPeerExtension:
    return a.back();
...
func count(value: PacketPeerExtension) -> int:
    _assert_not_null_PacketPeerExtension(value);
    return a.count(value);

func count_nullable(value: PacketPeerExtension) -> int:
    _assert_nullable_PacketPeerExtension(value);
    return a.count(value);
...
func erase(value: PacketPeerExtension):
    _assert_not_null_PacketPeerExtension(value);
    a.erase(value);

func erase_nullable(value: PacketPeerExtension):
    _assert_nullable_PacketPeerExtension(value);
    a.erase(value);

# TODO
# func fill(value: PacketPeerExtension)

func find(value: PacketPeerExtension) -> int:
    _assert_not_null_PacketPeerExtension(value);
    return a.find(value);

func find_nullable(value: PacketPeerExtension) -> int:
    _assert_nullable_PacketPeerExtension(value);
    return a.find(value);

#TODO
# func find_last(value: PacketPeerExtension)

# Returns the first element or crashes if empty
func front() -> PacketPeerExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> PacketPeerExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> PacketPeerExtension:
    if (a.empty()):
        return null;
    return a.front();

func has(value: PacketPeerExtension) -> bool:
    _assert_not_null_PacketPeerExtension(value);
    return a.has(value);

func has_nullable(value: PacketPeerExtension) -> bool:
    _assert_nullable_PacketPeerExtension(value);
    return a.has(value);
...
func insert(position: int, value: PacketPeerExtension):
    _assert_not_null_PacketPeerExtension(value);
    a.insert(position, value);

func insert_nullable(position: int, value: PacketPeerExtension):
    _assert_not_null_PacketPeerExtension(value);
    a.insert(position, value);
...
func max() -> PacketPeerExtension:
    var result: PacketPeerExtension = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> PacketPeerExtension:
    var result: PacketPeerExtension = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PacketPeerExtension = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PacketPeerExtension = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PacketPeerExtension = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> PacketPeerExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: PacketPeerExtension):
    _assert_not_null_PacketPeerExtension(value);
    a.push_back(value);

func push_back_nullable(value: PacketPeerExtension):
    _assert_nullable_PacketPeerExtension(value);
    a.push_back(value);


func push_front(value: PacketPeerExtension):
    _assert_not_null_PacketPeerExtension(value);
    a.push_front(value);

func push_front_nullable(value: PacketPeerExtension):
    _assert_nullable_PacketPeerExtension(value);
    a.push_back(value);
