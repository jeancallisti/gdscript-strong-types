...
# in which the values are of type 'char'.
# It is not meant to be attached to a char (unless you want to!)
...
func _assert_nullable_char(value: char):
    if (value == null):
        return

    if (!(value is char)):
        _crash("value was expected to be of type char")

func _assert_not_null_char(value: char):
    if (!(value is char)):
        _crash("value was expected to be of type char")

func _assert_all_nullable_char(values: Array):
    for v in values:
        _assert_nullable_char(v)

func _assert_all_not_null_char(values: Array):
    for v in values:
        _assert_not_null_char(v)

func set_at(position: int, value: char):
    _assert_not_null_char(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: char):
    _assert_nullable_char(value);
    a[position] = value;

func get_at(position: int) -> char:
    return a[position];
...
func add_nullable(value: char):
    _assert_nullable_char(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: char):
    _assert_not_null_char(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: char):
    _assert_nullable_char(value);
    a.append(value);
...
# func Contains(value: char) -> bool:
#     _assert_char(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_char(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_char(array);
    a.append_array(array);
...
func count(value: char) -> int:
    _assert_not_null_char(value);
    return a.count(value);

func count_nullable(value: char) -> int:
    _assert_nullable_char(value);
    return a.count(value);
...
func erase(value: char):
    _assert_not_null_char(value);
    a.erase(value);

func erase_nullable(value: char):
    _assert_nullable_char(value);
    a.erase(value);

# TODO
# func fill(value: char)

func find(value: char) -> int:
    _assert_not_null_char(value);
    return a.find(value);

func find_nullable(value: char) -> int:
    _assert_nullable_char(value);
    return a.find(value);

#TODO
# func find_last(value: char)
...
func first_or_default() -> char:
    if (a.empty()):
        return null;
    return a.front();

func has(value: char) -> bool:
    _assert_not_null_char(value);
    return a.has(value);

func has_nullable(value: char) -> bool:
    _assert_nullable_char(value);
    return a.has(value);
...
func insert(position: int, value: char):
    _assert_not_null_char(value);
    a.insert(position, value);

func insert_nullable(position: int, value: char):
    _assert_not_null_char(value);
    a.insert(position, value);
...
func pop_back() -> char:
    ...
    var result: char = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> char:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> char:
    ...
    var result: char = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> char:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: char):
    _assert_not_null_char(value);
    a.push_back(value);

func push_back_nullable(value: char):
    _assert_nullable_char(value);
    a.push_back(value);


func push_front(value: char):
    _assert_not_null_char(value);
    a.push_front(value);

func push_front_nullable(value: char):
    _assert_nullable_char(value);
    a.push_back(value);
