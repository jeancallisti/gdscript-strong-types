...
# in which the values are of type 'YSort'.
# It is not meant to be attached to a YSort (unless you want to!)
# You can generate more classes like this one for your own types.
class_name YSortArray
...
func _assert_nullable_YSort(value: YSort):
    ...
    if (!(value is YSort)):
        _crash("value was expected to be of type YSort")

func _assert_not_null_YSort(value: YSort):
    if (!(value is YSort)):
        _crash("value was expected to be of type YSort")

func _assert_all_nullable_YSort(values: Array):
    for v in values:
        _assert_nullable_YSort(v)

func _assert_all_not_null_YSort(values: Array):
    for v in values:
        _assert_not_null_YSort(v)

func set_at(position: int, value: YSort):
    _assert_not_null_YSort(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: YSort):
    _assert_nullable_YSort(value);
    a[position] = value;

func get_at(position: int) -> YSort:
    return a[position];

func add(value: YSort):
    _assert_not_null_YSort(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: YSort):
    _assert_nullable_YSort(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: YSort):
    _assert_not_null_YSort(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: YSort):
    _assert_nullable_YSort(value);
    a.append(value);
...
# func Contains(value: YSort) -> bool:
#     _assert_YSort(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_YSort(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_YSort(array);
    a.append_array(array);
...
func count(value: YSort) -> int:
    _assert_not_null_YSort(value);
    return a.count(value);

func count_nullable(value: YSort) -> int:
    _assert_nullable_YSort(value);
    return a.count(value);
...
func erase(value: YSort):
    _assert_not_null_YSort(value);
    a.erase(value);

func erase_nullable(value: YSort):
    _assert_nullable_YSort(value);
    a.erase(value);

# TODO
# func fill(value: YSort)

func find(value: YSort) -> int:
    _assert_not_null_YSort(value);
    return a.find(value);

func find_nullable(value: YSort) -> int:
    _assert_nullable_YSort(value);
    return a.find(value);

#TODO
# func find_last(value: YSort)
...
func first_or_default() -> YSort:
    if (a.empty()):
        return null;
    return a.front();

func has(value: YSort) -> bool:
    _assert_not_null_YSort(value);
    return a.has(value);

func has_nullable(value: YSort) -> bool:
    _assert_nullable_YSort(value);
    return a.has(value);
...
func insert(position: int, value: YSort):
    _assert_not_null_YSort(value);
    a.insert(position, value);

func insert_nullable(position: int, value: YSort):
    _assert_not_null_YSort(value);
    a.insert(position, value);
...
func pop_back() -> YSort:
    ...
    var result: YSort = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> YSort:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> YSort:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: YSort = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> YSort:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: YSort):
    _assert_not_null_YSort(value);
    a.push_back(value);

func push_back_nullable(value: YSort):
    _assert_nullable_YSort(value);
    a.push_back(value);


func push_front(value: YSort):
    _assert_not_null_YSort(value);
    a.push_front(value);

func push_front_nullable(value: YSort):
    _assert_nullable_YSort(value);
    a.push_back(value);
