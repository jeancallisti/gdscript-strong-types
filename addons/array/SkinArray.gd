...
# in which the values are of type 'Skin'.
# It is not meant to be attached to a Skin (unless you want to!)
# You can generate more classes like this one for your own types.
class_name SkinArray
...
func _assert_nullable_Skin(value: Skin):
    if (value == null):
        return

    if (!(value is Skin)):
        _crash("value was expected to be of type Skin")

func _assert_not_null_Skin(value: Skin):
    if (!(value is Skin)):
        _crash("value was expected to be of type Skin")

func _assert_all_nullable_Skin(values: Array):
    for v in values:
        _assert_nullable_Skin(v)

func _assert_all_not_null_Skin(values: Array):
    for v in values:
        _assert_not_null_Skin(v)

func set_at(position: int, value: Skin):
    _assert_not_null_Skin(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Skin):
    _assert_nullable_Skin(value);
    a[position] = value;

func get_at(position: int) -> Skin:
    return a[position];
...
func add_nullable(value: Skin):
    _assert_nullable_Skin(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Skin):
    _assert_not_null_Skin(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Skin):
    _assert_nullable_Skin(value);
    a.append(value);
...
# func Contains(value: Skin) -> bool:
#     _assert_Skin(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Skin(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Skin(array);
    a.append_array(array);
...
func count(value: Skin) -> int:
    _assert_not_null_Skin(value);
    return a.count(value);

func count_nullable(value: Skin) -> int:
    _assert_nullable_Skin(value);
    return a.count(value);
...
func erase(value: Skin):
    _assert_not_null_Skin(value);
    a.erase(value);

func erase_nullable(value: Skin):
    _assert_nullable_Skin(value);
    a.erase(value);

# TODO
# func fill(value: Skin)

func find(value: Skin) -> int:
    _assert_not_null_Skin(value);
    return a.find(value);

func find_nullable(value: Skin) -> int:
    _assert_nullable_Skin(value);
    return a.find(value);

#TODO
# func find_last(value: Skin)
...
func first_or_default() -> Skin:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Skin) -> bool:
    _assert_not_null_Skin(value);
    return a.has(value);

func has_nullable(value: Skin) -> bool:
    _assert_nullable_Skin(value);
    return a.has(value);
...
func insert(position: int, value: Skin):
    _assert_not_null_Skin(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Skin):
    _assert_not_null_Skin(value);
    a.insert(position, value);
...
func pop_back() -> Skin:
    ...
    var result: Skin = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Skin:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Skin:
    ...
    var result: Skin = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Skin:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Skin):
    _assert_not_null_Skin(value);
    a.push_back(value);

func push_back_nullable(value: Skin):
    _assert_nullable_Skin(value);
    a.push_back(value);


func push_front(value: Skin):
    _assert_not_null_Skin(value);
    a.push_front(value);

func push_front_nullable(value: Skin):
    _assert_nullable_Skin(value);
    a.push_back(value);
