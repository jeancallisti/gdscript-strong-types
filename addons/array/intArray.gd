...
# It is not meant to be attached to a int (unless you want to!)
...
func _assert_nullable_int(value: int):
    if (value == null):
        return
...
func _assert_all_nullable_int(values: Array):
    for v in values:
        _assert_nullable_int(v)

func _assert_all_not_null_int(values: Array):
    for v in values:
        _assert_not_null_int(v)
...
func append_array(array: Array):
    _assert_all_not_null_int(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_int(array);
    a.append_array(array);
...
func count_nullable(value: int) -> int:
    _assert_nullable_int(value);
    return a.count(value);
...
func find_nullable(value: int) -> int:
    _assert_nullable_int(value);
    return a.find(value);
...
func has_nullable(value: int) -> bool:
    _assert_nullable_int(value);
    return a.has(value);
...
func insert(position: int, value: int):
    _assert_not_null_int(value);
    a.insert(position, value);

func insert_nullable(position: int, value: int):
    _assert_not_null_int(value);
    a.insert(position, value);
...
func pop_back() -> int:
    ...
    var result: int = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> int:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> int:
    ...
    var result: int = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> int:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back_nullable(value: int):
    _assert_nullable_int(value);
    a.push_back(value);


func push_front(value: int):
    _assert_not_null_int(value);
    a.push_front(value);

func push_front_nullable(value: int):
    _assert_nullable_int(value);
    a.push_back(value);
