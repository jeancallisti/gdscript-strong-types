...
# It is not meant to be attached to a Image (unless you want to!)
...
func _assert_nullable_Image(value: Image):
    if (value == null):
        return
...
func _assert_all_nullable_Image(values: Array):
    for v in values:
        _assert_nullable_Image(v)

func _assert_all_not_null_Image(values: Array):
    for v in values:
        _assert_not_null_Image(v)
...
func append_array(array: Array):
    _assert_all_not_null_Image(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Image(array);
    a.append_array(array);
...
func count(value: Image) -> int:
    _assert_not_null_Image(value);
    return a.count(value);

func count_nullable(value: Image) -> int:
    _assert_nullable_Image(value);
    return a.count(value);
...
func erase(value: Image):
    _assert_not_null_Image(value);
    a.erase(value);

func erase_nullable(value: Image):
    _assert_nullable_Image(value);
    a.erase(value);

# TODO
# func fill(value: Image)

func find(value: Image) -> int:
    _assert_not_null_Image(value);
    return a.find(value);

func find_nullable(value: Image) -> int:
    _assert_nullable_Image(value);
    return a.find(value);

#TODO
# func find_last(value: Image)
...
func first_or_default() -> Image:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Image) -> bool:
    _assert_not_null_Image(value);
    return a.has(value);

func has_nullable(value: Image) -> bool:
    _assert_nullable_Image(value);
    return a.has(value);
...
func insert(position: int, value: Image):
    _assert_not_null_Image(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Image):
    _assert_not_null_Image(value);
    a.insert(position, value);
...
func pop_back() -> Image:
    ...
    var result: Image = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Image:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Image:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Image = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Image:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Image):
    _assert_not_null_Image(value);
    a.push_back(value);

func push_back_nullable(value: Image):
    _assert_nullable_Image(value);
    a.push_back(value);


func push_front(value: Image):
    _assert_not_null_Image(value);
    a.push_front(value);

func push_front_nullable(value: Image):
    _assert_nullable_Image(value);
    a.push_back(value);
