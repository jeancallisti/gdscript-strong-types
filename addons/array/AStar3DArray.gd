...
# It is not meant to be attached to a AStar3D (unless you want to!)
...
func _assert_nullable_AStar3D(value: AStar3D):
    if (value == null):
        return
...
func _assert_all_nullable_AStar3D(values: Array):
    for v in values:
        _assert_nullable_AStar3D(v)

func _assert_all_not_null_AStar3D(values: Array):
    for v in values:
        _assert_not_null_AStar3D(v)
...
func set_at_nullable(position: int, value: AStar3D):
    _assert_nullable_AStar3D(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_AStar3D(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_AStar3D(array);
    a.append_array(array);
...
func count(value: AStar3D) -> int:
    _assert_not_null_AStar3D(value);
    return a.count(value);

func count_nullable(value: AStar3D) -> int:
    _assert_nullable_AStar3D(value);
    return a.count(value);
...
func erase(value: AStar3D):
    _assert_not_null_AStar3D(value);
    a.erase(value);

func erase_nullable(value: AStar3D):
    _assert_nullable_AStar3D(value);
    a.erase(value);

# TODO
# func fill(value: AStar3D)

func find(value: AStar3D) -> int:
    _assert_not_null_AStar3D(value);
    return a.find(value);

func find_nullable(value: AStar3D) -> int:
    _assert_nullable_AStar3D(value);
    return a.find(value);

#TODO
# func find_last(value: AStar3D)
...
func first_or_default() -> AStar3D:
    if (a.empty()):
        return null;
    return a.front();

func has(value: AStar3D) -> bool:
    _assert_not_null_AStar3D(value);
    return a.has(value);

func has_nullable(value: AStar3D) -> bool:
    _assert_nullable_AStar3D(value);
    return a.has(value);
...
func insert(position: int, value: AStar3D):
    _assert_not_null_AStar3D(value);
    a.insert(position, value);

func insert_nullable(position: int, value: AStar3D):
    _assert_not_null_AStar3D(value);
    a.insert(position, value);
...
func pop_back() -> AStar3D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStar3D = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> AStar3D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> AStar3D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStar3D = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> AStar3D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: AStar3D):
    _assert_not_null_AStar3D(value);
    a.push_back(value);

func push_back_nullable(value: AStar3D):
    _assert_nullable_AStar3D(value);
    a.push_back(value);


func push_front(value: AStar3D):
    _assert_not_null_AStar3D(value);
    a.push_front(value);

func push_front_nullable(value: AStar3D):
    _assert_nullable_AStar3D(value);
    a.push_back(value);
