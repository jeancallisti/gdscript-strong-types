...
# in which the values are of type 'Time'.
# It is not meant to be attached to a Time (unless you want to!)
# You can generate more classes like this one for your own types.
class_name TimeArray
...
func _assert_nullable_Time(value: Time):
    if (value == null):
        return

    if (!(value is Time)):
        _crash("value was expected to be of type Time")

func _assert_not_null_Time(value: Time):
    if (!(value is Time)):
        _crash("value was expected to be of type Time")

func _assert_all_nullable_Time(values: Array):
    for v in values:
        _assert_nullable_Time(v)

func _assert_all_not_null_Time(values: Array):
    for v in values:
        _assert_not_null_Time(v)

func set_at(position: int, value: Time):
    _assert_not_null_Time(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Time):
    _assert_nullable_Time(value);
    a[position] = value;

func get_at(position: int) -> Time:
    return a[position];
...
func add_nullable(value: Time):
    _assert_nullable_Time(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Time):
    _assert_not_null_Time(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Time):
    _assert_nullable_Time(value);
    a.append(value);
...
# func Contains(value: Time) -> bool:
#     _assert_Time(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Time(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Time(array);
    a.append_array(array);
...
func count(value: Time) -> int:
    _assert_not_null_Time(value);
    return a.count(value);

func count_nullable(value: Time) -> int:
    _assert_nullable_Time(value);
    return a.count(value);
...
func erase(value: Time):
    _assert_not_null_Time(value);
    a.erase(value);

func erase_nullable(value: Time):
    _assert_nullable_Time(value);
    a.erase(value);

# TODO
# func fill(value: Time)

func find(value: Time) -> int:
    _assert_not_null_Time(value);
    return a.find(value);

func find_nullable(value: Time) -> int:
    _assert_nullable_Time(value);
    return a.find(value);

#TODO
# func find_last(value: Time)
...
func first_or_default() -> Time:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Time) -> bool:
    _assert_not_null_Time(value);
    return a.has(value);

func has_nullable(value: Time) -> bool:
    _assert_nullable_Time(value);
    return a.has(value);
...
func insert(position: int, value: Time):
    _assert_not_null_Time(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Time):
    _assert_not_null_Time(value);
    a.insert(position, value);
...
func pop_back() -> Time:
    ...
    var result: Time = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Time:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Time:
    ...
    var result: Time = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Time:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Time):
    _assert_not_null_Time(value);
    a.push_back(value);

func push_back_nullable(value: Time):
    _assert_nullable_Time(value);
    a.push_back(value);


func push_front(value: Time):
    _assert_not_null_Time(value);
    a.push_front(value);

func push_front_nullable(value: Time):
    _assert_nullable_Time(value);
    a.push_back(value);
