...
# in which the values are of type 'Input'.
# It is not meant to be attached to a Input (unless you want to!)
...
func _assert_nullable_Input(value: Input):
    ...
    if (!(value is Input)):
        _crash("value was expected to be of type Input")

func _assert_not_null_Input(value: Input):
    if (!(value is Input)):
        _crash("value was expected to be of type Input")

func _assert_all_nullable_Input(values: Array):
    for v in values:
        _assert_nullable_Input(v)

func _assert_all_not_null_Input(values: Array):
    for v in values:
        _assert_not_null_Input(v)

func set_at(position: int, value: Input):
    _assert_not_null_Input(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Input):
    _assert_nullable_Input(value);
    a[position] = value;

func get_at(position: int) -> Input:
    return a[position];

func add(value: Input):
    _assert_not_null_Input(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Input):
    _assert_nullable_Input(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Input):
    _assert_not_null_Input(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Input):
    _assert_nullable_Input(value);
    a.append(value);
...
# func Contains(value: Input) -> bool:
#     _assert_Input(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Input(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Input(array);
    a.append_array(array);
...
func count(value: Input) -> int:
    _assert_not_null_Input(value);
    return a.count(value);

func count_nullable(value: Input) -> int:
    _assert_nullable_Input(value);
    return a.count(value);
...
func erase(value: Input):
    _assert_not_null_Input(value);
    a.erase(value);

func erase_nullable(value: Input):
    _assert_nullable_Input(value);
    a.erase(value);

# TODO
# func fill(value: Input)

func find(value: Input) -> int:
    _assert_not_null_Input(value);
    return a.find(value);

func find_nullable(value: Input) -> int:
    _assert_nullable_Input(value);
    return a.find(value);

#TODO
# func find_last(value: Input)
...
func first_or_default() -> Input:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Input) -> bool:
    _assert_not_null_Input(value);
    return a.has(value);

func has_nullable(value: Input) -> bool:
    _assert_nullable_Input(value);
    return a.has(value);
...
func insert(position: int, value: Input):
    _assert_not_null_Input(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Input):
    _assert_not_null_Input(value);
    a.insert(position, value);
...
func pop_back() -> Input:
    ...
    var result: Input = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Input:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Input:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Input = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Input:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Input):
    _assert_not_null_Input(value);
    a.push_back(value);

func push_back_nullable(value: Input):
    _assert_nullable_Input(value);
    a.push_back(value);


func push_front(value: Input):
    _assert_not_null_Input(value);
    a.push_front(value);

func push_front_nullable(value: Input):
    _assert_nullable_Input(value);
    a.push_back(value);
