...
# in which the values are of type 'Room'.
# It is not meant to be attached to a Room (unless you want to!)
...
func _assert_nullable_Room(value: Room):
    if (value == null):
        return

    if (!(value is Room)):
        _crash("value was expected to be of type Room")

func _assert_not_null_Room(value: Room):
    if (!(value is Room)):
        _crash("value was expected to be of type Room")

func _assert_all_nullable_Room(values: Array):
    for v in values:
        _assert_nullable_Room(v)

func _assert_all_not_null_Room(values: Array):
    for v in values:
        _assert_not_null_Room(v)

func set_at(position: int, value: Room):
    _assert_not_null_Room(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Room):
    _assert_nullable_Room(value);
    a[position] = value;

func get_at(position: int) -> Room:
    return a[position];
...
func add_nullable(value: Room):
    _assert_nullable_Room(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Room):
    _assert_not_null_Room(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Room):
    _assert_nullable_Room(value);
    a.append(value);
...
# func Contains(value: Room) -> bool:
#     _assert_Room(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Room(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Room(array);
    a.append_array(array);
...
func count(value: Room) -> int:
    _assert_not_null_Room(value);
    return a.count(value);

func count_nullable(value: Room) -> int:
    _assert_nullable_Room(value);
    return a.count(value);
...
func erase(value: Room):
    _assert_not_null_Room(value);
    a.erase(value);

func erase_nullable(value: Room):
    _assert_nullable_Room(value);
    a.erase(value);

# TODO
# func fill(value: Room)

func find(value: Room) -> int:
    _assert_not_null_Room(value);
    return a.find(value);

func find_nullable(value: Room) -> int:
    _assert_nullable_Room(value);
    return a.find(value);

#TODO
# func find_last(value: Room)
...
func first_or_default() -> Room:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Room) -> bool:
    _assert_not_null_Room(value);
    return a.has(value);

func has_nullable(value: Room) -> bool:
    _assert_nullable_Room(value);
    return a.has(value);
...
func insert(position: int, value: Room):
    _assert_not_null_Room(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Room):
    _assert_not_null_Room(value);
    a.insert(position, value);
...
func pop_back() -> Room:
    ...
    var result: Room = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Room:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Room:
    ...
    var result: Room = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Room:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Room):
    _assert_not_null_Room(value);
    a.push_back(value);

func push_back_nullable(value: Room):
    _assert_nullable_Room(value);
    a.push_back(value);


func push_front(value: Room):
    _assert_not_null_Room(value);
    a.push_front(value);

func push_front_nullable(value: Room):
    _assert_nullable_Room(value);
    a.push_back(value);
