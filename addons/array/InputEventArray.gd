...
# It is not meant to be attached to a InputEvent (unless you want to!)
...
func _assert_nullable_InputEvent(value: InputEvent):
    if (value == null):
        return
...
func _assert_all_nullable_InputEvent(values: Array):
    for v in values:
        _assert_nullable_InputEvent(v)

func _assert_all_not_null_InputEvent(values: Array):
    for v in values:
        _assert_not_null_InputEvent(v)
...
func set_at_nullable(position: int, value: InputEvent):
    _assert_nullable_InputEvent(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_InputEvent(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_InputEvent(array);
    a.append_array(array);

func back() -> InputEvent:
    return a.back();
...
func count(value: InputEvent) -> int:
    _assert_not_null_InputEvent(value);
    return a.count(value);

func count_nullable(value: InputEvent) -> int:
    _assert_nullable_InputEvent(value);
    return a.count(value);
...
func erase(value: InputEvent):
    _assert_not_null_InputEvent(value);
    a.erase(value);

func erase_nullable(value: InputEvent):
    _assert_nullable_InputEvent(value);
    a.erase(value);

# TODO
# func fill(value: InputEvent)

func find(value: InputEvent) -> int:
    _assert_not_null_InputEvent(value);
    return a.find(value);

func find_nullable(value: InputEvent) -> int:
    _assert_nullable_InputEvent(value);
    return a.find(value);

#TODO
# func find_last(value: InputEvent)

# Returns the first element or crashes if empty
func front() -> InputEvent:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> InputEvent:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> InputEvent:
    if (a.empty()):
        return null;
    return a.front();

func has(value: InputEvent) -> bool:
    _assert_not_null_InputEvent(value);
    return a.has(value);

func has_nullable(value: InputEvent) -> bool:
    _assert_nullable_InputEvent(value);
    return a.has(value);
...
func insert(position: int, value: InputEvent):
    _assert_not_null_InputEvent(value);
    a.insert(position, value);

func insert_nullable(position: int, value: InputEvent):
    _assert_not_null_InputEvent(value);
    a.insert(position, value);
...
func pop_back() -> InputEvent:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: InputEvent = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> InputEvent:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> InputEvent:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: InputEvent = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> InputEvent:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: InputEvent):
    _assert_not_null_InputEvent(value);
    a.push_back(value);

func push_back_nullable(value: InputEvent):
    _assert_nullable_InputEvent(value);
    a.push_back(value);


func push_front(value: InputEvent):
    _assert_not_null_InputEvent(value);
    a.push_front(value);

func push_front_nullable(value: InputEvent):
    _assert_nullable_InputEvent(value);
    a.push_back(value);
