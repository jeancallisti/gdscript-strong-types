...
# in which the values are of type 'Shape'.
# It is not meant to be attached to a Shape (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ShapeArray
...
func _assert_nullable_Shape(value: Shape):
    if (value == null):
        return

    if (!(value is Shape)):
        _crash("value was expected to be of type Shape")

func _assert_not_null_Shape(value: Shape):
    if (!(value is Shape)):
        _crash("value was expected to be of type Shape")

func _assert_all_nullable_Shape(values: Array):
    for v in values:
        _assert_nullable_Shape(v)

func _assert_all_not_null_Shape(values: Array):
    for v in values:
        _assert_not_null_Shape(v)

func set_at(position: int, value: Shape):
    _assert_not_null_Shape(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Shape):
    _assert_nullable_Shape(value);
    a[position] = value;

func get_at(position: int) -> Shape:
    return a[position];

func add(value: Shape):
    _assert_not_null_Shape(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Shape):
    _assert_nullable_Shape(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Shape):
    _assert_not_null_Shape(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Shape):
    _assert_nullable_Shape(value);
    a.append(value);
...
# func Contains(value: Shape) -> bool:
#     _assert_Shape(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Shape(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Shape(array);
    a.append_array(array);
...
func count(value: Shape) -> int:
    _assert_not_null_Shape(value);
    return a.count(value);

func count_nullable(value: Shape) -> int:
    _assert_nullable_Shape(value);
    return a.count(value);
...
func erase(value: Shape):
    _assert_not_null_Shape(value);
    a.erase(value);

func erase_nullable(value: Shape):
    _assert_nullable_Shape(value);
    a.erase(value);

# TODO
# func fill(value: Shape)

func find(value: Shape) -> int:
    _assert_not_null_Shape(value);
    return a.find(value);

func find_nullable(value: Shape) -> int:
    _assert_nullable_Shape(value);
    return a.find(value);

#TODO
# func find_last(value: Shape)
...
func first_or_default() -> Shape:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Shape) -> bool:
    _assert_not_null_Shape(value);
    return a.has(value);

func has_nullable(value: Shape) -> bool:
    _assert_nullable_Shape(value);
    return a.has(value);
...
func insert(position: int, value: Shape):
    _assert_not_null_Shape(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Shape):
    _assert_not_null_Shape(value);
    a.insert(position, value);
...
func pop_back() -> Shape:
    ...
    var result: Shape = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Shape:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Shape:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Shape = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Shape:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Shape):
    _assert_not_null_Shape(value);
    a.push_back(value);

func push_back_nullable(value: Shape):
    _assert_nullable_Shape(value);
    a.push_back(value);


func push_front(value: Shape):
    _assert_not_null_Shape(value);
    a.push_front(value);

func push_front_nullable(value: Shape):
    _assert_nullable_Shape(value);
    a.push_back(value);
