...
# in which the values are of type 'Area'.
# It is not meant to be attached to a Area (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AreaArray
...
func _assert_nullable_Area(value: Area):
    if (value == null):
        return

    if (!(value is Area)):
        _crash("value was expected to be of type Area")

func _assert_not_null_Area(value: Area):
    if (!(value is Area)):
        _crash("value was expected to be of type Area")

func _assert_all_nullable_Area(values: Array):
    for v in values:
        _assert_nullable_Area(v)

func _assert_all_not_null_Area(values: Array):
    for v in values:
        _assert_not_null_Area(v)

func set_at(position: int, value: Area):
    _assert_not_null_Area(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Area):
    _assert_nullable_Area(value);
    a[position] = value;

func get_at(position: int) -> Area:
    return a[position];
...
func add_nullable(value: Area):
    _assert_nullable_Area(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Area):
    _assert_not_null_Area(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Area):
    _assert_nullable_Area(value);
    a.append(value);
...
# func Contains(value: Area) -> bool:
#     _assert_Area(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Area(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Area(array);
    a.append_array(array);
...
func count(value: Area) -> int:
    _assert_not_null_Area(value);
    return a.count(value);

func count_nullable(value: Area) -> int:
    _assert_nullable_Area(value);
    return a.count(value);
...
func erase(value: Area):
    _assert_not_null_Area(value);
    a.erase(value);

func erase_nullable(value: Area):
    _assert_nullable_Area(value);
    a.erase(value);

# TODO
# func fill(value: Area)

func find(value: Area) -> int:
    _assert_not_null_Area(value);
    return a.find(value);

func find_nullable(value: Area) -> int:
    _assert_nullable_Area(value);
    return a.find(value);

#TODO
# func find_last(value: Area)
...
func first_or_default() -> Area:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Area) -> bool:
    _assert_not_null_Area(value);
    return a.has(value);

func has_nullable(value: Area) -> bool:
    _assert_nullable_Area(value);
    return a.has(value);
...
func insert(position: int, value: Area):
    _assert_not_null_Area(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Area):
    _assert_not_null_Area(value);
    a.insert(position, value);
...
func pop_back() -> Area:
    ...
    var result: Area = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Area:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Area:
    ...
    var result: Area = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Area:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Area):
    _assert_not_null_Area(value);
    a.push_back(value);

func push_back_nullable(value: Area):
    _assert_nullable_Area(value);
    a.push_back(value);


func push_front(value: Area):
    _assert_not_null_Area(value);
    a.push_front(value);

func push_front_nullable(value: Area):
    _assert_nullable_Area(value);
    a.push_back(value);
