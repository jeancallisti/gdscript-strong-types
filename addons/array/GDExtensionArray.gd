...
# It is not meant to be attached to a GDExtension (unless you want to!)
...
func _assert_all_nullable_GDExtension(values: Array):
    for v in values:
        _assert_nullable_GDExtension(v)

func _assert_all_not_null_GDExtension(values: Array):
    for v in values:
        _assert_not_null_GDExtension(v)
...
func append_array(array: Array):
    _assert_all_not_null_GDExtension(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_GDExtension(array);
    a.append_array(array);

func back() -> GDExtension:
    return a.back();
...
func count(value: GDExtension) -> int:
    _assert_not_null_GDExtension(value);
    return a.count(value);

func count_nullable(value: GDExtension) -> int:
    _assert_nullable_GDExtension(value);
    return a.count(value);
...
func erase(value: GDExtension):
    _assert_not_null_GDExtension(value);
    a.erase(value);

func erase_nullable(value: GDExtension):
    _assert_nullable_GDExtension(value);
    a.erase(value);

# TODO
# func fill(value: GDExtension)

func find(value: GDExtension) -> int:
    _assert_not_null_GDExtension(value);
    return a.find(value);

func find_nullable(value: GDExtension) -> int:
    _assert_nullable_GDExtension(value);
    return a.find(value);

#TODO
# func find_last(value: GDExtension)

# Returns the first element or crashes if empty
func front() -> GDExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> GDExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> GDExtension:
    if (a.empty()):
        return null;
    return a.front();

func has(value: GDExtension) -> bool:
    _assert_not_null_GDExtension(value);
    return a.has(value);

func has_nullable(value: GDExtension) -> bool:
    _assert_nullable_GDExtension(value);
    return a.has(value);
...
func insert(position: int, value: GDExtension):
    _assert_not_null_GDExtension(value);
    a.insert(position, value);

func insert_nullable(position: int, value: GDExtension):
    _assert_not_null_GDExtension(value);
    a.insert(position, value);
...
func max() -> GDExtension:
    var result: GDExtension = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> GDExtension:
    var result: GDExtension = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtension = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtension = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtension = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> GDExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: GDExtension):
    _assert_not_null_GDExtension(value);
    a.push_back(value);

func push_back_nullable(value: GDExtension):
    _assert_nullable_GDExtension(value);
    a.push_back(value);


func push_front(value: GDExtension):
    _assert_not_null_GDExtension(value);
    a.push_front(value);

func push_front_nullable(value: GDExtension):
    _assert_nullable_GDExtension(value);
    a.push_back(value);
