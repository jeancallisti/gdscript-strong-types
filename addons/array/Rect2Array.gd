...
# in which the values are of type 'Rect2'.
# It is not meant to be attached to a Rect2 (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Rect2Array
...
func _assert_nullable_Rect2(value: Rect2):
    if (value == null):
        return

    if (!(value is Rect2)):
        _crash("value was expected to be of type Rect2")

func _assert_not_null_Rect2(value: Rect2):
    if (!(value is Rect2)):
        _crash("value was expected to be of type Rect2")

func _assert_all_nullable_Rect2(values: Array):
    for v in values:
        _assert_nullable_Rect2(v)

func _assert_all_not_null_Rect2(values: Array):
    for v in values:
        _assert_not_null_Rect2(v)

func set_at(position: int, value: Rect2):
    _assert_not_null_Rect2(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Rect2):
    _assert_nullable_Rect2(value);
    a[position] = value;

func get_at(position: int) -> Rect2:
    return a[position];
...
func add_nullable(value: Rect2):
    _assert_nullable_Rect2(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Rect2):
    _assert_not_null_Rect2(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Rect2):
    _assert_nullable_Rect2(value);
    a.append(value);
...
# func Contains(value: Rect2) -> bool:
#     _assert_Rect2(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Rect2(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Rect2(array);
    a.append_array(array);
...
func count(value: Rect2) -> int:
    _assert_not_null_Rect2(value);
    return a.count(value);

func count_nullable(value: Rect2) -> int:
    _assert_nullable_Rect2(value);
    return a.count(value);
...
func erase(value: Rect2):
    _assert_not_null_Rect2(value);
    a.erase(value);

func erase_nullable(value: Rect2):
    _assert_nullable_Rect2(value);
    a.erase(value);

# TODO
# func fill(value: Rect2)

func find(value: Rect2) -> int:
    _assert_not_null_Rect2(value);
    return a.find(value);

func find_nullable(value: Rect2) -> int:
    _assert_nullable_Rect2(value);
    return a.find(value);

#TODO
# func find_last(value: Rect2)
...
func first_or_default() -> Rect2:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Rect2) -> bool:
    _assert_not_null_Rect2(value);
    return a.has(value);

func has_nullable(value: Rect2) -> bool:
    _assert_nullable_Rect2(value);
    return a.has(value);
...
func insert(position: int, value: Rect2):
    _assert_not_null_Rect2(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Rect2):
    _assert_not_null_Rect2(value);
    a.insert(position, value);
...
func pop_back() -> Rect2:
    ...
    var result: Rect2 = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Rect2:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Rect2:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Rect2 = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Rect2:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Rect2):
    _assert_not_null_Rect2(value);
    a.push_back(value);

func push_back_nullable(value: Rect2):
    _assert_nullable_Rect2(value);
    a.push_back(value);


func push_front(value: Rect2):
    _assert_not_null_Rect2(value);
    a.push_front(value);

func push_front_nullable(value: Rect2):
    _assert_nullable_Rect2(value);
    a.push_back(value);
