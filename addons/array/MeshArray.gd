...
# in which the values are of type 'Mesh'.
# It is not meant to be attached to a Mesh (unless you want to!)
# You can generate more classes like this one for your own types.
class_name MeshArray
...
func _assert_nullable_Mesh(value: Mesh):
    if (value == null):
        return

    if (!(value is Mesh)):
        _crash("value was expected to be of type Mesh")

func _assert_not_null_Mesh(value: Mesh):
    if (!(value is Mesh)):
        _crash("value was expected to be of type Mesh")

func _assert_all_nullable_Mesh(values: Array):
    for v in values:
        _assert_nullable_Mesh(v)

func _assert_all_not_null_Mesh(values: Array):
    for v in values:
        _assert_not_null_Mesh(v)

func set_at(position: int, value: Mesh):
    _assert_not_null_Mesh(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Mesh):
    _assert_nullable_Mesh(value);
    a[position] = value;

func get_at(position: int) -> Mesh:
    return a[position];
...
func add_nullable(value: Mesh):
    _assert_nullable_Mesh(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Mesh):
    _assert_not_null_Mesh(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Mesh):
    _assert_nullable_Mesh(value);
    a.append(value);
...
# func Contains(value: Mesh) -> bool:
#     _assert_Mesh(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Mesh(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Mesh(array);
    a.append_array(array);
...
func count(value: Mesh) -> int:
    _assert_not_null_Mesh(value);
    return a.count(value);

func count_nullable(value: Mesh) -> int:
    _assert_nullable_Mesh(value);
    return a.count(value);
...
func erase(value: Mesh):
    _assert_not_null_Mesh(value);
    a.erase(value);

func erase_nullable(value: Mesh):
    _assert_nullable_Mesh(value);
    a.erase(value);

# TODO
# func fill(value: Mesh)

func find(value: Mesh) -> int:
    _assert_not_null_Mesh(value);
    return a.find(value);

func find_nullable(value: Mesh) -> int:
    _assert_nullable_Mesh(value);
    return a.find(value);

#TODO
# func find_last(value: Mesh)
...
func first_or_default() -> Mesh:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Mesh) -> bool:
    _assert_not_null_Mesh(value);
    return a.has(value);

func has_nullable(value: Mesh) -> bool:
    _assert_nullable_Mesh(value);
    return a.has(value);
...
func insert(position: int, value: Mesh):
    _assert_not_null_Mesh(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Mesh):
    _assert_not_null_Mesh(value);
    a.insert(position, value);
...
func pop_back() -> Mesh:
    ...
    var result: Mesh = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Mesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Mesh:
    ...
    var result: Mesh = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Mesh:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Mesh):
    _assert_not_null_Mesh(value);
    a.push_back(value);

func push_back_nullable(value: Mesh):
    _assert_nullable_Mesh(value);
    a.push_back(value);


func push_front(value: Mesh):
    _assert_not_null_Mesh(value);
    a.push_front(value);

func push_front_nullable(value: Mesh):
    _assert_nullable_Mesh(value);
    a.push_back(value);
