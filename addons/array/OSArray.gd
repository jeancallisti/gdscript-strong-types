...
# in which the values are of type 'OS'.
# It is not meant to be attached to a OS (unless you want to!)
...
func _assert_nullable_OS(value: OS):
    if (value == null):
        return

    if (!(value is OS)):
        _crash("value was expected to be of type OS")

func _assert_not_null_OS(value: OS):
    if (!(value is OS)):
        _crash("value was expected to be of type OS")

func _assert_all_nullable_OS(values: Array):
    for v in values:
        _assert_nullable_OS(v)

func _assert_all_not_null_OS(values: Array):
    for v in values:
        _assert_not_null_OS(v)

func set_at(position: int, value: OS):
    _assert_not_null_OS(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: OS):
    _assert_nullable_OS(value);
    a[position] = value;

func get_at(position: int) -> OS:
    return a[position];
...
func add_nullable(value: OS):
    _assert_nullable_OS(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: OS):
    _assert_not_null_OS(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: OS):
    _assert_nullable_OS(value);
    a.append(value);
...
func count(value: OS) -> int:
    _assert_not_null_OS(value);
    return a.count(value);

func count_nullable(value: OS) -> int:
    _assert_nullable_OS(value);
    return a.count(value);
...
func find(value: OS) -> int:
    _assert_not_null_OS(value);
    return a.find(value);

func find_nullable(value: OS) -> int:
    _assert_nullable_OS(value);
    return a.find(value);

#TODO
# func find_last(value: OS)
...
func first_or_default() -> OS:
    if (a.empty()):
        return null;
    return a.front();

func has(value: OS) -> bool:
    _assert_not_null_OS(value);
    return a.has(value);

func has_nullable(value: OS) -> bool:
    _assert_nullable_OS(value);
    return a.has(value);
...
func insert(position: int, value: OS):
    _assert_not_null_OS(value);
    a.insert(position, value);

func insert_nullable(position: int, value: OS):
    _assert_not_null_OS(value);
    a.insert(position, value);
...
func pop_at(position: int) -> OS:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: OS = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> OS:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> OS:
    ...
    var result: OS = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> OS:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> OS:
    ...
    var result: OS = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> OS:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: OS):
    _assert_not_null_OS(value);
    a.push_back(value);

func push_back_nullable(value: OS):
    _assert_nullable_OS(value);
    a.push_back(value);


func push_front(value: OS):
    _assert_not_null_OS(value);
    a.push_front(value);

func push_front_nullable(value: OS):
    _assert_nullable_OS(value);
    a.push_back(value);
