...
# It is not meant to be attached to a WeakRef (unless you want to!)
...
func _assert_nullable_WeakRef(value: WeakRef):
    if (value == null):
        return
...
func _assert_all_nullable_WeakRef(values: Array):
    for v in values:
        _assert_nullable_WeakRef(v)

func _assert_all_not_null_WeakRef(values: Array):
    for v in values:
        _assert_not_null_WeakRef(v)
...
func set_at_nullable(position: int, value: WeakRef):
    _assert_nullable_WeakRef(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_WeakRef(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_WeakRef(array);
    a.append_array(array);
...
func count(value: WeakRef) -> int:
    _assert_not_null_WeakRef(value);
    return a.count(value);

func count_nullable(value: WeakRef) -> int:
    _assert_nullable_WeakRef(value);
    return a.count(value);
...
func erase(value: WeakRef):
    _assert_not_null_WeakRef(value);
    a.erase(value);

func erase_nullable(value: WeakRef):
    _assert_nullable_WeakRef(value);
    a.erase(value);

# TODO
# func fill(value: WeakRef)

func find(value: WeakRef) -> int:
    _assert_not_null_WeakRef(value);
    return a.find(value);

func find_nullable(value: WeakRef) -> int:
    _assert_nullable_WeakRef(value);
    return a.find(value);

#TODO
# func find_last(value: WeakRef)
...
func first_or_default() -> WeakRef:
    if (a.empty()):
        return null;
    return a.front();

func has(value: WeakRef) -> bool:
    _assert_not_null_WeakRef(value);
    return a.has(value);

func has_nullable(value: WeakRef) -> bool:
    _assert_nullable_WeakRef(value);
    return a.has(value);
...
func insert(position: int, value: WeakRef):
    _assert_not_null_WeakRef(value);
    a.insert(position, value);

func insert_nullable(position: int, value: WeakRef):
    _assert_not_null_WeakRef(value);
    a.insert(position, value);
...
func pop_back() -> WeakRef:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: WeakRef = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> WeakRef:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> WeakRef:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: WeakRef = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> WeakRef:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: WeakRef):
    _assert_not_null_WeakRef(value);
    a.push_back(value);

func push_back_nullable(value: WeakRef):
    _assert_nullable_WeakRef(value);
    a.push_back(value);


func push_front(value: WeakRef):
    _assert_not_null_WeakRef(value);
    a.push_front(value);

func push_front_nullable(value: WeakRef):
    _assert_nullable_WeakRef(value);
    a.push_back(value);
