...
# in which the values are of type 'Color'.
# It is not meant to be attached to a Color (unless you want to!)
...
func _assert_nullable_Color(value: Color):
    if (value == null):
        return

    if (!(value is Color)):
        _crash("value was expected to be of type Color")

func _assert_not_null_Color(value: Color):
    if (!(value is Color)):
        _crash("value was expected to be of type Color")

func _assert_all_nullable_Color(values: Array):
    for v in values:
        _assert_nullable_Color(v)

func _assert_all_not_null_Color(values: Array):
    for v in values:
        _assert_not_null_Color(v)

func set_at(position: int, value: Color):
    _assert_not_null_Color(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Color):
    _assert_nullable_Color(value);
    a[position] = value;

func get_at(position: int) -> Color:
    return a[position];

func add(value: Color):
    _assert_not_null_Color(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Color):
    _assert_nullable_Color(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Color):
    _assert_not_null_Color(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Color):
    _assert_nullable_Color(value);
    a.append(value);
...
# func Contains(value: Color) -> bool:
#     _assert_Color(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Color(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Color(array);
    a.append_array(array);
...
func count_nullable(value: Color) -> int:
    _assert_nullable_Color(value);
    return a.count(value);
...
func erase(value: Color):
    _assert_not_null_Color(value);
    a.erase(value);

func erase_nullable(value: Color):
    _assert_nullable_Color(value);
    a.erase(value);
...
func find(value: Color) -> int:
    _assert_not_null_Color(value);
    return a.find(value);

func find_nullable(value: Color) -> int:
    _assert_nullable_Color(value);
    return a.find(value);

#TODO
# func find_last(value: Color)
...
func has_nullable(value: Color) -> bool:
    _assert_nullable_Color(value);
    return a.has(value);
...
func insert(position: int, value: Color):
    _assert_not_null_Color(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Color):
    _assert_not_null_Color(value);
    a.insert(position, value);
...
func pop_back() -> Color:
    ...
    var result: Color = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Color:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Color:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Color = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Color:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Color):
    _assert_not_null_Color(value);
    a.push_back(value);

func push_back_nullable(value: Color):
    _assert_nullable_Color(value);
    a.push_back(value);


func push_front(value: Color):
    _assert_not_null_Color(value);
    a.push_front(value);

func push_front_nullable(value: Color):
    _assert_nullable_Color(value);
    a.push_back(value);
