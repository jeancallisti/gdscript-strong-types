...
# in which the values are of type 'Font'.
# It is not meant to be attached to a Font (unless you want to!)
# You can generate more classes like this one for your own types.
class_name FontArray
...
func _assert_nullable_Font(value: Font):
    if (value == null):
        return

    if (!(value is Font)):
        _crash("value was expected to be of type Font")

func _assert_not_null_Font(value: Font):
    if (!(value is Font)):
        _crash("value was expected to be of type Font")

func _assert_all_nullable_Font(values: Array):
    for v in values:
        _assert_nullable_Font(v)

func _assert_all_not_null_Font(values: Array):
    for v in values:
        _assert_not_null_Font(v)

func set_at(position: int, value: Font):
    _assert_not_null_Font(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Font):
    _assert_nullable_Font(value);
    a[position] = value;

func get_at(position: int) -> Font:
    return a[position];
...
func add_nullable(value: Font):
    _assert_nullable_Font(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Font):
    _assert_not_null_Font(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Font):
    _assert_nullable_Font(value);
    a.append(value);
...
# func Contains(value: Font) -> bool:
#     _assert_Font(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Font(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Font(array);
    a.append_array(array);
...
func count(value: Font) -> int:
    _assert_not_null_Font(value);
    return a.count(value);

func count_nullable(value: Font) -> int:
    _assert_nullable_Font(value);
    return a.count(value);
...
func erase(value: Font):
    _assert_not_null_Font(value);
    a.erase(value);

func erase_nullable(value: Font):
    _assert_nullable_Font(value);
    a.erase(value);

# TODO
# func fill(value: Font)

func find(value: Font) -> int:
    _assert_not_null_Font(value);
    return a.find(value);

func find_nullable(value: Font) -> int:
    _assert_nullable_Font(value);
    return a.find(value);

#TODO
# func find_last(value: Font)
...
func first_or_default() -> Font:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Font) -> bool:
    _assert_not_null_Font(value);
    return a.has(value);

func has_nullable(value: Font) -> bool:
    _assert_nullable_Font(value);
    return a.has(value);
...
func insert(position: int, value: Font):
    _assert_not_null_Font(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Font):
    _assert_not_null_Font(value);
    a.insert(position, value);
...
func pop_back() -> Font:
    ...
    var result: Font = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Font:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Font:
    ...
    var result: Font = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Font:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Font):
    _assert_not_null_Font(value);
    a.push_back(value);

func push_back_nullable(value: Font):
    _assert_nullable_Font(value);
    a.push_back(value);


func push_front(value: Font):
    _assert_not_null_Font(value);
    a.push_front(value);

func push_front_nullable(value: Font):
    _assert_nullable_Font(value);
    a.push_back(value);
