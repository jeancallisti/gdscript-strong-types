...
# in which the values are of type 'Curve'.
# It is not meant to be attached to a Curve (unless you want to!)
...
func _assert_nullable_Curve(value: Curve):
    if (value == null):
        return

    if (!(value is Curve)):
        _crash("value was expected to be of type Curve")

func _assert_not_null_Curve(value: Curve):
    if (!(value is Curve)):
        _crash("value was expected to be of type Curve")

func _assert_all_nullable_Curve(values: Array):
    for v in values:
        _assert_nullable_Curve(v)

func _assert_all_not_null_Curve(values: Array):
    for v in values:
        _assert_not_null_Curve(v)

func set_at(position: int, value: Curve):
    _assert_not_null_Curve(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Curve):
    _assert_nullable_Curve(value);
    a[position] = value;

func get_at(position: int) -> Curve:
    return a[position];

func add(value: Curve):
    _assert_not_null_Curve(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Curve):
    _assert_nullable_Curve(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Curve):
    _assert_not_null_Curve(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Curve):
    _assert_nullable_Curve(value);
    a.append(value);
...
# func Contains(value: Curve) -> bool:
#     _assert_Curve(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Curve(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Curve(array);
    a.append_array(array);
...
func count(value: Curve) -> int:
    _assert_not_null_Curve(value);
    return a.count(value);

func count_nullable(value: Curve) -> int:
    _assert_nullable_Curve(value);
    return a.count(value);
...
func erase(value: Curve):
    _assert_not_null_Curve(value);
    a.erase(value);

func erase_nullable(value: Curve):
    _assert_nullable_Curve(value);
    a.erase(value);

# TODO
# func fill(value: Curve)

func find(value: Curve) -> int:
    _assert_not_null_Curve(value);
    return a.find(value);

func find_nullable(value: Curve) -> int:
    _assert_nullable_Curve(value);
    return a.find(value);

#TODO
# func find_last(value: Curve)
...
func first_or_default() -> Curve:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Curve) -> bool:
    _assert_not_null_Curve(value);
    return a.has(value);

func has_nullable(value: Curve) -> bool:
    _assert_nullable_Curve(value);
    return a.has(value);
...
func insert(position: int, value: Curve):
    _assert_not_null_Curve(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Curve):
    _assert_not_null_Curve(value);
    a.insert(position, value);
...
func pop_back() -> Curve:
    ...
    var result: Curve = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Curve:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Curve:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Curve = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Curve:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Curve):
    _assert_not_null_Curve(value);
    a.push_back(value);

func push_back_nullable(value: Curve):
    _assert_nullable_Curve(value);
    a.push_back(value);


func push_front(value: Curve):
    _assert_not_null_Curve(value);
    a.push_front(value);

func push_front_nullable(value: Curve):
    _assert_nullable_Curve(value);
    a.push_back(value);
