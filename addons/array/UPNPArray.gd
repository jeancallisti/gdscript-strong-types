...
# in which the values are of type 'UPNP'.
# It is not meant to be attached to a UPNP (unless you want to!)
# You can generate more classes like this one for your own types.
class_name UPNPArray
...
func _assert_nullable_UPNP(value: UPNP):
    if (value == null):
        return

    if (!(value is UPNP)):
        _crash("value was expected to be of type UPNP")

func _assert_not_null_UPNP(value: UPNP):
    if (!(value is UPNP)):
        _crash("value was expected to be of type UPNP")

func _assert_all_nullable_UPNP(values: Array):
    for v in values:
        _assert_nullable_UPNP(v)

func _assert_all_not_null_UPNP(values: Array):
    for v in values:
        _assert_not_null_UPNP(v)

func set_at(position: int, value: UPNP):
    _assert_not_null_UPNP(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: UPNP):
    _assert_nullable_UPNP(value);
    a[position] = value;

func get_at(position: int) -> UPNP:
    return a[position];
...
func add_nullable(value: UPNP):
    _assert_nullable_UPNP(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: UPNP):
    _assert_not_null_UPNP(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: UPNP):
    _assert_nullable_UPNP(value);
    a.append(value);
...
# func Contains(value: UPNP) -> bool:
#     _assert_UPNP(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_UPNP(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_UPNP(array);
    a.append_array(array);
...
func count(value: UPNP) -> int:
    _assert_not_null_UPNP(value);
    return a.count(value);

func count_nullable(value: UPNP) -> int:
    _assert_nullable_UPNP(value);
    return a.count(value);
...
func erase(value: UPNP):
    _assert_not_null_UPNP(value);
    a.erase(value);

func erase_nullable(value: UPNP):
    _assert_nullable_UPNP(value);
    a.erase(value);

# TODO
# func fill(value: UPNP)

func find(value: UPNP) -> int:
    _assert_not_null_UPNP(value);
    return a.find(value);

func find_nullable(value: UPNP) -> int:
    _assert_nullable_UPNP(value);
    return a.find(value);

#TODO
# func find_last(value: UPNP)
...
func first_or_default() -> UPNP:
    if (a.empty()):
        return null;
    return a.front();

func has(value: UPNP) -> bool:
    _assert_not_null_UPNP(value);
    return a.has(value);

func has_nullable(value: UPNP) -> bool:
    _assert_nullable_UPNP(value);
    return a.has(value);
...
func insert(position: int, value: UPNP):
    _assert_not_null_UPNP(value);
    a.insert(position, value);

func insert_nullable(position: int, value: UPNP):
    _assert_not_null_UPNP(value);
    a.insert(position, value);
...
func pop_back() -> UPNP:
    ...
    var result: UPNP = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> UPNP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> UPNP:
    ...
    var result: UPNP = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> UPNP:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: UPNP):
    _assert_not_null_UPNP(value);
    a.push_back(value);

func push_back_nullable(value: UPNP):
    _assert_nullable_UPNP(value);
    a.push_back(value);


func push_front(value: UPNP):
    _assert_not_null_UPNP(value);
    a.push_front(value);

func push_front_nullable(value: UPNP):
    _assert_nullable_UPNP(value);
    a.push_back(value);
