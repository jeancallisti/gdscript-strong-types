...
# in which the values are of type 'Panel'.
# It is not meant to be attached to a Panel (unless you want to!)
# You can generate more classes like this one for your own types.
class_name PanelArray
...
func _assert_nullable_Panel(value: Panel):
    if (value == null):
        return

    if (!(value is Panel)):
        _crash("value was expected to be of type Panel")

func _assert_not_null_Panel(value: Panel):
    if (!(value is Panel)):
        _crash("value was expected to be of type Panel")

func _assert_all_nullable_Panel(values: Array):
    for v in values:
        _assert_nullable_Panel(v)

func _assert_all_not_null_Panel(values: Array):
    for v in values:
        _assert_not_null_Panel(v)

func set_at(position: int, value: Panel):
    _assert_not_null_Panel(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Panel):
    _assert_nullable_Panel(value);
    a[position] = value;

func get_at(position: int) -> Panel:
    return a[position];

func add(value: Panel):
    _assert_not_null_Panel(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Panel):
    _assert_nullable_Panel(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Panel):
    _assert_not_null_Panel(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Panel):
    _assert_nullable_Panel(value);
    a.append(value);
...
# func Contains(value: Panel) -> bool:
#     _assert_Panel(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Panel(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Panel(array);
    a.append_array(array);
...
func count(value: Panel) -> int:
    _assert_not_null_Panel(value);
    return a.count(value);

func count_nullable(value: Panel) -> int:
    _assert_nullable_Panel(value);
    return a.count(value);
...
func erase(value: Panel):
    _assert_not_null_Panel(value);
    a.erase(value);

func erase_nullable(value: Panel):
    _assert_nullable_Panel(value);
    a.erase(value);

# TODO
# func fill(value: Panel)

func find(value: Panel) -> int:
    _assert_not_null_Panel(value);
    return a.find(value);

func find_nullable(value: Panel) -> int:
    _assert_nullable_Panel(value);
    return a.find(value);

#TODO
# func find_last(value: Panel)
...
func first_or_default() -> Panel:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Panel) -> bool:
    _assert_not_null_Panel(value);
    return a.has(value);

func has_nullable(value: Panel) -> bool:
    _assert_nullable_Panel(value);
    return a.has(value);
...
func insert(position: int, value: Panel):
    _assert_not_null_Panel(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Panel):
    _assert_not_null_Panel(value);
    a.insert(position, value);
...
func pop_back() -> Panel:
    ...
    var result: Panel = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Panel:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Panel:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Panel = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Panel:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Panel):
    _assert_not_null_Panel(value);
    a.push_back(value);

func push_back_nullable(value: Panel):
    _assert_nullable_Panel(value);
    a.push_back(value);


func push_front(value: Panel):
    _assert_not_null_Panel(value);
    a.push_front(value);

func push_front_nullable(value: Panel):
    _assert_nullable_Panel(value);
    a.push_back(value);
