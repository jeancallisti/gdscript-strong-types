...
# in which the values are of type 'Tree'.
# It is not meant to be attached to a Tree (unless you want to!)
...
func _assert_nullable_Tree(value: Tree):
    if (value == null):
        return

    if (!(value is Tree)):
        _crash("value was expected to be of type Tree")

func _assert_not_null_Tree(value: Tree):
    if (!(value is Tree)):
        _crash("value was expected to be of type Tree")

func _assert_all_nullable_Tree(values: Array):
    for v in values:
        _assert_nullable_Tree(v)

func _assert_all_not_null_Tree(values: Array):
    for v in values:
        _assert_not_null_Tree(v)

func set_at(position: int, value: Tree):
    _assert_not_null_Tree(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Tree):
    _assert_nullable_Tree(value);
    a[position] = value;

func get_at(position: int) -> Tree:
    return a[position];
...
func add_nullable(value: Tree):
    _assert_nullable_Tree(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Tree):
    _assert_not_null_Tree(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Tree):
    _assert_nullable_Tree(value);
    a.append(value);
...
# func Contains(value: Tree) -> bool:
#     _assert_Tree(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Tree(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Tree(array);
    a.append_array(array);
...
func count(value: Tree) -> int:
    _assert_not_null_Tree(value);
    return a.count(value);

func count_nullable(value: Tree) -> int:
    _assert_nullable_Tree(value);
    return a.count(value);
...
func erase(value: Tree):
    _assert_not_null_Tree(value);
    a.erase(value);

func erase_nullable(value: Tree):
    _assert_nullable_Tree(value);
    a.erase(value);

# TODO
# func fill(value: Tree)

func find(value: Tree) -> int:
    _assert_not_null_Tree(value);
    return a.find(value);

func find_nullable(value: Tree) -> int:
    _assert_nullable_Tree(value);
    return a.find(value);

#TODO
# func find_last(value: Tree)
...
func first_or_default() -> Tree:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Tree) -> bool:
    _assert_not_null_Tree(value);
    return a.has(value);

func has_nullable(value: Tree) -> bool:
    _assert_nullable_Tree(value);
    return a.has(value);
...
func insert(position: int, value: Tree):
    _assert_not_null_Tree(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Tree):
    _assert_not_null_Tree(value);
    a.insert(position, value);
...
func pop_back() -> Tree:
    ...
    var result: Tree = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Tree:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Tree:
    ...
    var result: Tree = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Tree:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Tree):
    _assert_not_null_Tree(value);
    a.push_back(value);

func push_back_nullable(value: Tree):
    _assert_nullable_Tree(value);
    a.push_back(value);


func push_front(value: Tree):
    _assert_not_null_Tree(value);
    a.push_front(value);

func push_front_nullable(value: Tree):
    _assert_nullable_Tree(value);
    a.push_back(value);
