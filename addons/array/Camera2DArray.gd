...
# in which the values are of type 'Camera2D'.
# It is not meant to be attached to a Camera2D (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Camera2DArray
...
func _assert_nullable_Camera2D(value: Camera2D):
    ...
    if (!(value is Camera2D)):
        _crash("value was expected to be of type Camera2D")

func _assert_not_null_Camera2D(value: Camera2D):
    if (!(value is Camera2D)):
        _crash("value was expected to be of type Camera2D")

func _assert_all_nullable_Camera2D(values: Array):
    for v in values:
        _assert_nullable_Camera2D(v)

func _assert_all_not_null_Camera2D(values: Array):
    for v in values:
        _assert_not_null_Camera2D(v)

func set_at(position: int, value: Camera2D):
    _assert_not_null_Camera2D(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Camera2D):
    _assert_nullable_Camera2D(value);
    a[position] = value;

func get_at(position: int) -> Camera2D:
    return a[position];

func add(value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Camera2D):
    _assert_nullable_Camera2D(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Camera2D):
    _assert_nullable_Camera2D(value);
    a.append(value);
...
# func Contains(value: Camera2D) -> bool:
#     _assert_Camera2D(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Camera2D(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Camera2D(array);
    a.append_array(array);
...
func count(value: Camera2D) -> int:
    _assert_not_null_Camera2D(value);
    return a.count(value);

func count_nullable(value: Camera2D) -> int:
    _assert_nullable_Camera2D(value);
    return a.count(value);
...
func erase(value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.erase(value);

func erase_nullable(value: Camera2D):
    _assert_nullable_Camera2D(value);
    a.erase(value);

# TODO
# func fill(value: Camera2D)

func find(value: Camera2D) -> int:
    _assert_not_null_Camera2D(value);
    return a.find(value);

func find_nullable(value: Camera2D) -> int:
    _assert_nullable_Camera2D(value);
    return a.find(value);

#TODO
# func find_last(value: Camera2D)
...
func first_or_default() -> Camera2D:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Camera2D) -> bool:
    _assert_not_null_Camera2D(value);
    return a.has(value);

func has_nullable(value: Camera2D) -> bool:
    _assert_nullable_Camera2D(value);
    return a.has(value);
...
func insert(position: int, value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.insert(position, value);
...
func pop_back() -> Camera2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Camera2D = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Camera2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Camera2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Camera2D = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Camera2D:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.push_back(value);

func push_back_nullable(value: Camera2D):
    _assert_nullable_Camera2D(value);
    a.push_back(value);


func push_front(value: Camera2D):
    _assert_not_null_Camera2D(value);
    a.push_front(value);

func push_front_nullable(value: Camera2D):
    _assert_nullable_Camera2D(value);
    a.push_back(value);
