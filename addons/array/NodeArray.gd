...
# in which the values are of type 'Node'.
...
func _assert_nullable_Node(value: Node):
    if (value == null):
        return
...
func _assert_all_nullable_Node(values: Array):
    for v in values:
        _assert_nullable_Node(v)

func _assert_all_not_null_Node(values: Array):
    for v in values:
        _assert_not_null_Node(v)

func set_at(position: int, value: Node):
    _assert_not_null_Node(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Node):
    _assert_nullable_Node(value);
    a[position] = value;

func get_at(position: int) -> Node:
    return a[position];
...
func append_nullable(value: Node):
    _assert_nullable_Node(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_Node(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Node(array);
    a.append_array(array);
...
func count(value: Node) -> int:
    _assert_not_null_Node(value);
    return a.count(value);

func count_nullable(value: Node) -> int:
    _assert_nullable_Node(value);
    return a.count(value);
...
func erase(value: Node):
    _assert_not_null_Node(value);
    a.erase(value);

func erase_nullable(value: Node):
    _assert_nullable_Node(value);
    a.erase(value);

# TODO
# func fill(value: Node)

func find(value: Node) -> int:
    _assert_not_null_Node(value);
    return a.find(value);

func find_nullable(value: Node) -> int:
    _assert_nullable_Node(value);
    return a.find(value);

#TODO
# func find_last(value: Node)
...
func has_nullable(value: Node) -> bool:
    _assert_nullable_Node(value);
    return a.has(value);
...
func insert(position: int, value: Node):
    _assert_not_null_Node(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Node):
    _assert_not_null_Node(value);
    a.insert(position, value);
...
func pop_back() -> Node:
    ...
    var result: Node = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Node:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Node:
    ...
    var result: Node = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Node:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Node):
    _assert_not_null_Node(value);
    a.push_back(value);

func push_back_nullable(value: Node):
    _assert_nullable_Node(value);
    a.push_back(value);


func push_front(value: Node):
    _assert_not_null_Node(value);
    a.push_front(value);

func push_front_nullable(value: Node):
    _assert_nullable_Node(value);
    a.push_back(value);
