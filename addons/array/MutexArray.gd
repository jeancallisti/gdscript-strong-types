...
# It is not meant to be attached to a Mutex (unless you want to!)
...
func _assert_nullable_Mutex(value: Mutex):
    if (value == null):
        return
...
func _assert_all_nullable_Mutex(values: Array):
    for v in values:
        _assert_nullable_Mutex(v)

func _assert_all_not_null_Mutex(values: Array):
    for v in values:
        _assert_not_null_Mutex(v)
...
func append_array(array: Array):
    _assert_all_not_null_Mutex(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Mutex(array);
    a.append_array(array);
...
func count(value: Mutex) -> int:
    _assert_not_null_Mutex(value);
    return a.count(value);

func count_nullable(value: Mutex) -> int:
    _assert_nullable_Mutex(value);
    return a.count(value);
...
func erase(value: Mutex):
    _assert_not_null_Mutex(value);
    a.erase(value);

func erase_nullable(value: Mutex):
    _assert_nullable_Mutex(value);
    a.erase(value);

# TODO
# func fill(value: Mutex)

func find(value: Mutex) -> int:
    _assert_not_null_Mutex(value);
    return a.find(value);

func find_nullable(value: Mutex) -> int:
    _assert_nullable_Mutex(value);
    return a.find(value);

#TODO
# func find_last(value: Mutex)
...
func first_or_default() -> Mutex:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Mutex) -> bool:
    _assert_not_null_Mutex(value);
    return a.has(value);

func has_nullable(value: Mutex) -> bool:
    _assert_nullable_Mutex(value);
    return a.has(value);
...
func insert(position: int, value: Mutex):
    _assert_not_null_Mutex(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Mutex):
    _assert_not_null_Mutex(value);
    a.insert(position, value);
...
func pop_back() -> Mutex:
    ...
    var result: Mutex = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Mutex:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Mutex:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Mutex = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Mutex:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Mutex):
    _assert_not_null_Mutex(value);
    a.push_back(value);

func push_back_nullable(value: Mutex):
    _assert_nullable_Mutex(value);
    a.push_back(value);


func push_front(value: Mutex):
    _assert_not_null_Mutex(value);
    a.push_front(value);

func push_front_nullable(value: Mutex):
    _assert_nullable_Mutex(value);
    a.push_back(value);
