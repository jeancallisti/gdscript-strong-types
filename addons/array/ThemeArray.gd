...
# in which the values are of type 'Theme'.
# It is not meant to be attached to a Theme (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ThemeArray
...
func _assert_nullable_Theme(value: Theme):
    if (value == null):
        return

    if (!(value is Theme)):
        _crash("value was expected to be of type Theme")

func _assert_not_null_Theme(value: Theme):
    if (!(value is Theme)):
        _crash("value was expected to be of type Theme")

func _assert_all_nullable_Theme(values: Array):
    for v in values:
        _assert_nullable_Theme(v)

func _assert_all_not_null_Theme(values: Array):
    for v in values:
        _assert_not_null_Theme(v)

func set_at(position: int, value: Theme):
    _assert_not_null_Theme(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Theme):
    _assert_nullable_Theme(value);
    a[position] = value;

func get_at(position: int) -> Theme:
    return a[position];

func add(value: Theme):
    _assert_not_null_Theme(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Theme):
    _assert_nullable_Theme(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Theme):
    _assert_not_null_Theme(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Theme):
    _assert_nullable_Theme(value);
    a.append(value);
...
# func Contains(value: Theme) -> bool:
#     _assert_Theme(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Theme(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Theme(array);
    a.append_array(array);
...
func count(value: Theme) -> int:
    _assert_not_null_Theme(value);
    return a.count(value);

func count_nullable(value: Theme) -> int:
    _assert_nullable_Theme(value);
    return a.count(value);
...
func erase(value: Theme):
    _assert_not_null_Theme(value);
    a.erase(value);

func erase_nullable(value: Theme):
    _assert_nullable_Theme(value);
    a.erase(value);

# TODO
# func fill(value: Theme)

func find(value: Theme) -> int:
    _assert_not_null_Theme(value);
    return a.find(value);

func find_nullable(value: Theme) -> int:
    _assert_nullable_Theme(value);
    return a.find(value);

#TODO
# func find_last(value: Theme)
...
func first_or_default() -> Theme:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Theme) -> bool:
    _assert_not_null_Theme(value);
    return a.has(value);

func has_nullable(value: Theme) -> bool:
    _assert_nullable_Theme(value);
    return a.has(value);
...
func insert(position: int, value: Theme):
    _assert_not_null_Theme(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Theme):
    _assert_not_null_Theme(value);
    a.insert(position, value);
...
func pop_back() -> Theme:
    ...
    var result: Theme = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Theme:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Theme:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Theme = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Theme:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Theme):
    _assert_not_null_Theme(value);
    a.push_back(value);

func push_back_nullable(value: Theme):
    _assert_nullable_Theme(value);
    a.push_back(value);


func push_front(value: Theme):
    _assert_not_null_Theme(value);
    a.push_front(value);

func push_front_nullable(value: Theme):
    _assert_nullable_Theme(value);
    a.push_back(value);
