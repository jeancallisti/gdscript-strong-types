...
# in which the values are of type 'File'.
# It is not meant to be attached to a File (unless you want to!)
# You can generate more classes like this one for your own types.
class_name FileArray
...
func _assert_nullable_File(value: File):
    if (value == null):
        return

    if (!(value is File)):
        _crash("value was expected to be of type File")

func _assert_not_null_File(value: File):
    if (!(value is File)):
        _crash("value was expected to be of type File")

func _assert_all_nullable_File(values: Array):
    for v in values:
        _assert_nullable_File(v)

func _assert_all_not_null_File(values: Array):
    for v in values:
        _assert_not_null_File(v)

func set_at(position: int, value: File):
    _assert_not_null_File(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: File):
    _assert_nullable_File(value);
    a[position] = value;

func get_at(position: int) -> File:
    return a[position];
...
func add_nullable(value: File):
    _assert_nullable_File(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: File):
    _assert_not_null_File(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: File):
    _assert_nullable_File(value);
    a.append(value);
...
# func Contains(value: File) -> bool:
#     _assert_File(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_File(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_File(array);
    a.append_array(array);
...
func count(value: File) -> int:
    _assert_not_null_File(value);
    return a.count(value);

func count_nullable(value: File) -> int:
    _assert_nullable_File(value);
    return a.count(value);
...
func erase(value: File):
    _assert_not_null_File(value);
    a.erase(value);

func erase_nullable(value: File):
    _assert_nullable_File(value);
    a.erase(value);

# TODO
# func fill(value: File)

func find(value: File) -> int:
    _assert_not_null_File(value);
    return a.find(value);

func find_nullable(value: File) -> int:
    _assert_nullable_File(value);
    return a.find(value);

#TODO
# func find_last(value: File)
...
func first_or_default() -> File:
    if (a.empty()):
        return null;
    return a.front();

func has(value: File) -> bool:
    _assert_not_null_File(value);
    return a.has(value);

func has_nullable(value: File) -> bool:
    _assert_nullable_File(value);
    return a.has(value);
...
func insert(position: int, value: File):
    _assert_not_null_File(value);
    a.insert(position, value);

func insert_nullable(position: int, value: File):
    _assert_not_null_File(value);
    a.insert(position, value);
...
func pop_back() -> File:
    ...
    var result: File = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> File:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> File:
    ...
    var result: File = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> File:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: File):
    _assert_not_null_File(value);
    a.push_back(value);

func push_back_nullable(value: File):
    _assert_nullable_File(value);
    a.push_back(value);


func push_front(value: File):
    _assert_not_null_File(value);
    a.push_front(value);

func push_front_nullable(value: File):
    _assert_nullable_File(value);
    a.push_back(value);
