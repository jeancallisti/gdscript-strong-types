...
# It is not meant to be attached to a ResourceImporter (unless you want to!)
...
func _assert_nullable_ResourceImporter(value: ResourceImporter):
    if (value == null):
        return
...
func _assert_all_nullable_ResourceImporter(values: Array):
    for v in values:
        _assert_nullable_ResourceImporter(v)

func _assert_all_not_null_ResourceImporter(values: Array):
    for v in values:
        _assert_not_null_ResourceImporter(v)
...
func set_at_nullable(position: int, value: ResourceImporter):
    _assert_nullable_ResourceImporter(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_ResourceImporter(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_ResourceImporter(array);
    a.append_array(array);

func back() -> ResourceImporter:
    return a.back();
...
func count(value: ResourceImporter) -> int:
    _assert_not_null_ResourceImporter(value);
    return a.count(value);

func count_nullable(value: ResourceImporter) -> int:
    _assert_nullable_ResourceImporter(value);
    return a.count(value);
...
func erase(value: ResourceImporter):
    _assert_not_null_ResourceImporter(value);
    a.erase(value);

func erase_nullable(value: ResourceImporter):
    _assert_nullable_ResourceImporter(value);
    a.erase(value);

# TODO
# func fill(value: ResourceImporter)

func find(value: ResourceImporter) -> int:
    _assert_not_null_ResourceImporter(value);
    return a.find(value);

func find_nullable(value: ResourceImporter) -> int:
    _assert_nullable_ResourceImporter(value);
    return a.find(value);

#TODO
# func find_last(value: ResourceImporter)

# Returns the first element or crashes if empty
func front() -> ResourceImporter:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> ResourceImporter:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> ResourceImporter:
    if (a.empty()):
        return null;
    return a.front();

func has(value: ResourceImporter) -> bool:
    _assert_not_null_ResourceImporter(value);
    return a.has(value);

func has_nullable(value: ResourceImporter) -> bool:
    _assert_nullable_ResourceImporter(value);
    return a.has(value);
...
func insert(position: int, value: ResourceImporter):
    _assert_not_null_ResourceImporter(value);
    a.insert(position, value);

func insert_nullable(position: int, value: ResourceImporter):
    _assert_not_null_ResourceImporter(value);
    a.insert(position, value);
...
func max() -> ResourceImporter:
    var result: ResourceImporter = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> ResourceImporter:
    var result: ResourceImporter = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ResourceImporter = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ResourceImporter = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ResourceImporter = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> ResourceImporter:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: ResourceImporter):
    _assert_not_null_ResourceImporter(value);
    a.push_back(value);

func push_back_nullable(value: ResourceImporter):
    _assert_nullable_ResourceImporter(value);
    a.push_back(value);


func push_front(value: ResourceImporter):
    _assert_not_null_ResourceImporter(value);
    a.push_front(value);

func push_front_nullable(value: ResourceImporter):
    _assert_nullable_ResourceImporter(value);
    a.push_back(value);
