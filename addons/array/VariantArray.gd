...
# in which the values are of type 'Variant'.
# It is not meant to be attached to a Variant (unless you want to!)
# You can generate more classes like this one for your own types.
class_name VariantArray
...
func _assert_nullable_Variant(value: Variant):
    if (value == null):
        return

    if (!(value is Variant)):
        _crash("value was expected to be of type Variant")

func _assert_not_null_Variant(value: Variant):
    if (!(value is Variant)):
        _crash("value was expected to be of type Variant")

func _assert_all_nullable_Variant(values: Array):
    for v in values:
        _assert_nullable_Variant(v)

func _assert_all_not_null_Variant(values: Array):
    for v in values:
        _assert_not_null_Variant(v)

func set_at(position: int, value: Variant):
    _assert_not_null_Variant(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Variant):
    _assert_nullable_Variant(value);
    a[position] = value;
...
func add_nullable(value: Variant):
    _assert_nullable_Variant(value);
    a.append(value);
...
func append_nullable(value: Variant):
    _assert_nullable_Variant(value);
    a.append(value);
...
func count_nullable(value: Variant) -> int:
    _assert_nullable_Variant(value);
    return a.count(value);
...
func erase_nullable(value: Variant):
    _assert_nullable_Variant(value);
    a.erase(value);
...
func find(value: Variant) -> int:
    _assert_not_null_Variant(value);
    return a.find(value);

func find_nullable(value: Variant) -> int:
    _assert_nullable_Variant(value);
    return a.find(value);

#TODO
# func find_last(value: Variant)
...
func has_nullable(value: Variant) -> bool:
    _assert_nullable_Variant(value);
    return a.has(value);
...
func insert_nullable(position: int, value: Variant):
    _assert_not_null_Variant(value);
    a.insert(position, value);
...
func pop_at(position: int) -> Variant:
    ...
    var result: Variant = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> Variant:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> Variant:
    ...
    var result: Variant = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Variant:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Variant:
    ...
    var result: Variant = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Variant:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back_nullable(value: Variant):
    _assert_nullable_Variant(value);
    a.push_back(value);
...
func push_front_nullable(value: Variant):
    _assert_nullable_Variant(value);
    a.push_back(value);
