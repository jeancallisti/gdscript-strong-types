...
# in which the values are of type 'Vector3'.
# It is not meant to be attached to a Vector3 (unless you want to!)
# You can generate more classes like this one for your own types.
class_name Vector3Array
...
func _assert_nullable_Vector3(value: Vector3):
    if (value == null):
        return

    if (!(value is Vector3)):
        _crash("value was expected to be of type Vector3")

func _assert_not_null_Vector3(value: Vector3):
    if (!(value is Vector3)):
        _crash("value was expected to be of type Vector3")

func _assert_all_nullable_Vector3(values: Array):
    for v in values:
        _assert_nullable_Vector3(v)

func _assert_all_not_null_Vector3(values: Array):
    for v in values:
        _assert_not_null_Vector3(v)

func set_at(position: int, value: Vector3):
    _assert_not_null_Vector3(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Vector3):
    _assert_nullable_Vector3(value);
    a[position] = value;

func get_at(position: int) -> Vector3:
    return a[position];

func add(value: Vector3):
    _assert_not_null_Vector3(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Vector3):
    _assert_nullable_Vector3(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Vector3):
    _assert_not_null_Vector3(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Vector3):
    _assert_nullable_Vector3(value);
    a.append(value);
...
# func Contains(value: Vector3) -> bool:
#     _assert_Vector3(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Vector3(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Vector3(array);
    a.append_array(array);
...
func count_nullable(value: Vector3) -> int:
    _assert_nullable_Vector3(value);
    return a.count(value);
...
func erase(value: Vector3):
    _assert_not_null_Vector3(value);
    a.erase(value);

func erase_nullable(value: Vector3):
    _assert_nullable_Vector3(value);
    a.erase(value);
...
func find(value: Vector3) -> int:
    _assert_not_null_Vector3(value);
    return a.find(value);

func find_nullable(value: Vector3) -> int:
    _assert_nullable_Vector3(value);
    return a.find(value);

#TODO
# func find_last(value: Vector3)
...
func has_nullable(value: Vector3) -> bool:
    _assert_nullable_Vector3(value);
    return a.has(value);
...
func insert(position: int, value: Vector3):
    _assert_not_null_Vector3(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Vector3):
    _assert_not_null_Vector3(value);
    a.insert(position, value);
...
func pop_back() -> Vector3:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Vector3 = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Vector3:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Vector3:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Vector3 = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Vector3:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Vector3):
    _assert_not_null_Vector3(value);
    a.push_back(value);

func push_back_nullable(value: Vector3):
    _assert_nullable_Vector3(value);
    a.push_back(value);


func push_front(value: Vector3):
    _assert_not_null_Vector3(value);
    a.push_front(value);

func push_front_nullable(value: Vector3):
    _assert_nullable_Vector3(value);
    a.push_back(value);
