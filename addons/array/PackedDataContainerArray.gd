...
# It is not meant to be attached to a PackedDataContainer (unless you want to!)
...
func _assert_nullable_PackedDataContainer(value: PackedDataContainer):
    if (value == null):
        return
...
func _assert_all_nullable_PackedDataContainer(values: Array):
    for v in values:
        _assert_nullable_PackedDataContainer(v)

func _assert_all_not_null_PackedDataContainer(values: Array):
    for v in values:
        _assert_not_null_PackedDataContainer(v)
...
func set_at_nullable(position: int, value: PackedDataContainer):
    _assert_nullable_PackedDataContainer(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_PackedDataContainer(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_PackedDataContainer(array);
    a.append_array(array);

func back() -> PackedDataContainer:
    return a.back();
...
func count(value: PackedDataContainer) -> int:
    _assert_not_null_PackedDataContainer(value);
    return a.count(value);

func count_nullable(value: PackedDataContainer) -> int:
    _assert_nullable_PackedDataContainer(value);
    return a.count(value);
...
func erase(value: PackedDataContainer):
    _assert_not_null_PackedDataContainer(value);
    a.erase(value);

func erase_nullable(value: PackedDataContainer):
    _assert_nullable_PackedDataContainer(value);
    a.erase(value);

# TODO
# func fill(value: PackedDataContainer)

func find(value: PackedDataContainer) -> int:
    _assert_not_null_PackedDataContainer(value);
    return a.find(value);

func find_nullable(value: PackedDataContainer) -> int:
    _assert_nullable_PackedDataContainer(value);
    return a.find(value);

#TODO
# func find_last(value: PackedDataContainer)

# Returns the first element or crashes if empty
func front() -> PackedDataContainer:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> PackedDataContainer:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> PackedDataContainer:
    if (a.empty()):
        return null;
    return a.front();

func has(value: PackedDataContainer) -> bool:
    _assert_not_null_PackedDataContainer(value);
    return a.has(value);

func has_nullable(value: PackedDataContainer) -> bool:
    _assert_nullable_PackedDataContainer(value);
    return a.has(value);
...
func insert(position: int, value: PackedDataContainer):
    _assert_not_null_PackedDataContainer(value);
    a.insert(position, value);

func insert_nullable(position: int, value: PackedDataContainer):
    _assert_not_null_PackedDataContainer(value);
    a.insert(position, value);
...
func max() -> PackedDataContainer:
    var result: PackedDataContainer = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> PackedDataContainer:
    var result: PackedDataContainer = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PackedDataContainer = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PackedDataContainer = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: PackedDataContainer = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> PackedDataContainer:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: PackedDataContainer):
    _assert_not_null_PackedDataContainer(value);
    a.push_back(value);

func push_back_nullable(value: PackedDataContainer):
    _assert_nullable_PackedDataContainer(value);
    a.push_back(value);


func push_front(value: PackedDataContainer):
    _assert_not_null_PackedDataContainer(value);
    a.push_front(value);

func push_front_nullable(value: PackedDataContainer):
    _assert_nullable_PackedDataContainer(value);
    a.push_back(value);
