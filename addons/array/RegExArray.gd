...
# in which the values are of type 'RegEx'.
# It is not meant to be attached to a RegEx (unless you want to!)
# You can generate more classes like this one for your own types.
class_name RegExArray
...
func _assert_nullable_RegEx(value: RegEx):
    if (value == null):
        return

    if (!(value is RegEx)):
        _crash("value was expected to be of type RegEx")

func _assert_not_null_RegEx(value: RegEx):
    if (!(value is RegEx)):
        _crash("value was expected to be of type RegEx")

func _assert_all_nullable_RegEx(values: Array):
    for v in values:
        _assert_nullable_RegEx(v)

func _assert_all_not_null_RegEx(values: Array):
    for v in values:
        _assert_not_null_RegEx(v)

func set_at(position: int, value: RegEx):
    _assert_not_null_RegEx(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: RegEx):
    _assert_nullable_RegEx(value);
    a[position] = value;

func get_at(position: int) -> RegEx:
    return a[position];

func add(value: RegEx):
    _assert_not_null_RegEx(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: RegEx):
    _assert_nullable_RegEx(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: RegEx):
    _assert_not_null_RegEx(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: RegEx):
    _assert_nullable_RegEx(value);
    a.append(value);
...
# func Contains(value: RegEx) -> bool:
#     _assert_RegEx(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_RegEx(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_RegEx(array);
    a.append_array(array);
...
func count(value: RegEx) -> int:
    _assert_not_null_RegEx(value);
    return a.count(value);

func count_nullable(value: RegEx) -> int:
    _assert_nullable_RegEx(value);
    return a.count(value);
...
func erase(value: RegEx):
    _assert_not_null_RegEx(value);
    a.erase(value);

func erase_nullable(value: RegEx):
    _assert_nullable_RegEx(value);
    a.erase(value);

# TODO
# func fill(value: RegEx)

func find(value: RegEx) -> int:
    _assert_not_null_RegEx(value);
    return a.find(value);

func find_nullable(value: RegEx) -> int:
    _assert_nullable_RegEx(value);
    return a.find(value);

#TODO
# func find_last(value: RegEx)
...
func first_or_default() -> RegEx:
    if (a.empty()):
        return null;
    return a.front();

func has(value: RegEx) -> bool:
    _assert_not_null_RegEx(value);
    return a.has(value);

func has_nullable(value: RegEx) -> bool:
    _assert_nullable_RegEx(value);
    return a.has(value);
...
func insert(position: int, value: RegEx):
    _assert_not_null_RegEx(value);
    a.insert(position, value);

func insert_nullable(position: int, value: RegEx):
    _assert_not_null_RegEx(value);
    a.insert(position, value);
...
func pop_back() -> RegEx:
    ...
    var result: RegEx = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> RegEx:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> RegEx:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: RegEx = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> RegEx:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: RegEx):
    _assert_not_null_RegEx(value);
    a.push_back(value);

func push_back_nullable(value: RegEx):
    _assert_nullable_RegEx(value);
    a.push_back(value);


func push_front(value: RegEx):
    _assert_not_null_RegEx(value);
    a.push_front(value);

func push_front_nullable(value: RegEx):
    _assert_nullable_RegEx(value);
    a.push_back(value);
