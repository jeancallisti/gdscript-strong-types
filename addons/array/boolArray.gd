...
# in which the values are of type 'bool'.
# It is not meant to be attached to a bool (unless you want to!)
# You can generate more classes like this one for your own types.
class_name boolArray
...
func _assert_nullable_bool(value: bool):
    if (value == null):
        return

    if (!(value is bool)):
        _crash("value was expected to be of type bool")

func _assert_not_null_bool(value: bool):
    if (!(value is bool)):
        _crash("value was expected to be of type bool")

func _assert_all_nullable_bool(values: Array):
    for v in values:
        _assert_nullable_bool(v)

func _assert_all_not_null_bool(values: Array):
    for v in values:
        _assert_not_null_bool(v)

func set_at(position: int, value: bool):
    _assert_not_null_bool(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: bool):
    _assert_nullable_bool(value);
    a[position] = value;

func get_at(position: int) -> bool:
    return a[position];
...
func append_nullable(value: bool):
    _assert_nullable_bool(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_bool(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_bool(array);
    a.append_array(array);
...
func count_nullable(value: bool) -> int:
    _assert_nullable_bool(value);
    return a.count(value);
...
func erase_nullable(value: bool):
    _assert_nullable_bool(value);
    a.erase(value);
...
func find(value: bool) -> int:
    _assert_not_null_bool(value);
    return a.find(value);

func find_nullable(value: bool) -> int:
    _assert_nullable_bool(value);
    return a.find(value);

#TODO
# func find_last(value: bool)
...
func first_or_default() -> bool:
    if (a.empty()):
        return null;
    return a.front();

func has(value: bool) -> bool:
    _assert_not_null_bool(value);
    return a.has(value);

func has_nullable(value: bool) -> bool:
    _assert_nullable_bool(value);
    return a.has(value);
...
func insert(position: int, value: bool):
    _assert_not_null_bool(value);
    a.insert(position, value);

func insert_nullable(position: int, value: bool):
    _assert_not_null_bool(value);
    a.insert(position, value);
...
func pop_back() -> bool:
    ...
    var result: bool = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> bool:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> bool:
    ...
    var result: bool = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> bool:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back_nullable(value: bool):
    _assert_nullable_bool(value);
    a.push_back(value);
...
func push_front_nullable(value: bool):
    _assert_nullable_bool(value);
    a.push_back(value);
