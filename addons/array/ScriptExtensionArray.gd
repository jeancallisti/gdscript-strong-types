...
# It is not meant to be attached to a ScriptExtension (unless you want to!)
...
func _assert_nullable_ScriptExtension(value: ScriptExtension):
    if (value == null):
        return
...
func _assert_all_nullable_ScriptExtension(values: Array):
    for v in values:
        _assert_nullable_ScriptExtension(v)

func _assert_all_not_null_ScriptExtension(values: Array):
    for v in values:
        _assert_not_null_ScriptExtension(v)
...
func set_at_nullable(position: int, value: ScriptExtension):
    _assert_nullable_ScriptExtension(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_ScriptExtension(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_ScriptExtension(array);
    a.append_array(array);

func back() -> ScriptExtension:
    return a.back();
...
func count(value: ScriptExtension) -> int:
    _assert_not_null_ScriptExtension(value);
    return a.count(value);

func count_nullable(value: ScriptExtension) -> int:
    _assert_nullable_ScriptExtension(value);
    return a.count(value);
...
func erase(value: ScriptExtension):
    _assert_not_null_ScriptExtension(value);
    a.erase(value);

func erase_nullable(value: ScriptExtension):
    _assert_nullable_ScriptExtension(value);
    a.erase(value);

# TODO
# func fill(value: ScriptExtension)

func find(value: ScriptExtension) -> int:
    _assert_not_null_ScriptExtension(value);
    return a.find(value);

func find_nullable(value: ScriptExtension) -> int:
    _assert_nullable_ScriptExtension(value);
    return a.find(value);

#TODO
# func find_last(value: ScriptExtension)

# Returns the first element or crashes if empty
func front() -> ScriptExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> ScriptExtension:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> ScriptExtension:
    if (a.empty()):
        return null;
    return a.front();

func has(value: ScriptExtension) -> bool:
    _assert_not_null_ScriptExtension(value);
    return a.has(value);

func has_nullable(value: ScriptExtension) -> bool:
    _assert_nullable_ScriptExtension(value);
    return a.has(value);
...
func insert(position: int, value: ScriptExtension):
    _assert_not_null_ScriptExtension(value);
    a.insert(position, value);

func insert_nullable(position: int, value: ScriptExtension):
    _assert_not_null_ScriptExtension(value);
    a.insert(position, value);
...
func max() -> ScriptExtension:
    var result: ScriptExtension = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> ScriptExtension:
    var result: ScriptExtension = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ScriptExtension = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ScriptExtension = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ScriptExtension = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> ScriptExtension:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: ScriptExtension):
    _assert_not_null_ScriptExtension(value);
    a.push_back(value);

func push_back_nullable(value: ScriptExtension):
    _assert_nullable_ScriptExtension(value);
    a.push_back(value);


func push_front(value: ScriptExtension):
    _assert_not_null_ScriptExtension(value);
    a.push_front(value);

func push_front_nullable(value: ScriptExtension):
    _assert_nullable_ScriptExtension(value);
    a.push_back(value);
