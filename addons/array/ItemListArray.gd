...
# in which the values are of type 'ItemList'.
# It is not meant to be attached to a ItemList (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ItemListArray
...
func _assert_nullable_ItemList(value: ItemList):
    ...
    if (!(value is ItemList)):
        _crash("value was expected to be of type ItemList")

func _assert_not_null_ItemList(value: ItemList):
    if (!(value is ItemList)):
        _crash("value was expected to be of type ItemList")

func _assert_all_nullable_ItemList(values: Array):
    for v in values:
        _assert_nullable_ItemList(v)

func _assert_all_not_null_ItemList(values: Array):
    for v in values:
        _assert_not_null_ItemList(v)

func set_at(position: int, value: ItemList):
    _assert_not_null_ItemList(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: ItemList):
    _assert_nullable_ItemList(value);
    a[position] = value;

func get_at(position: int) -> ItemList:
    return a[position];

func add(value: ItemList):
    _assert_not_null_ItemList(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: ItemList):
    _assert_nullable_ItemList(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: ItemList):
    _assert_not_null_ItemList(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: ItemList):
    _assert_nullable_ItemList(value);
    a.append(value);
...
# func Contains(value: ItemList) -> bool:
#     _assert_ItemList(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_ItemList(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_ItemList(array);
    a.append_array(array);
...
func count(value: ItemList) -> int:
    _assert_not_null_ItemList(value);
    return a.count(value);

func count_nullable(value: ItemList) -> int:
    _assert_nullable_ItemList(value);
    return a.count(value);
...
func erase(value: ItemList):
    _assert_not_null_ItemList(value);
    a.erase(value);

func erase_nullable(value: ItemList):
    _assert_nullable_ItemList(value);
    a.erase(value);

# TODO
# func fill(value: ItemList)

func find(value: ItemList) -> int:
    _assert_not_null_ItemList(value);
    return a.find(value);

func find_nullable(value: ItemList) -> int:
    _assert_nullable_ItemList(value);
    return a.find(value);

#TODO
# func find_last(value: ItemList)
...
func first_or_default() -> ItemList:
    if (a.empty()):
        return null;
    return a.front();

func has(value: ItemList) -> bool:
    _assert_not_null_ItemList(value);
    return a.has(value);

func has_nullable(value: ItemList) -> bool:
    _assert_nullable_ItemList(value);
    return a.has(value);
...
func insert(position: int, value: ItemList):
    _assert_not_null_ItemList(value);
    a.insert(position, value);

func insert_nullable(position: int, value: ItemList):
    _assert_not_null_ItemList(value);
    a.insert(position, value);
...
func pop_back() -> ItemList:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ItemList = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> ItemList:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> ItemList:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: ItemList = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> ItemList:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: ItemList):
    _assert_not_null_ItemList(value);
    a.push_back(value);

func push_back_nullable(value: ItemList):
    _assert_nullable_ItemList(value);
    a.push_back(value);


func push_front(value: ItemList):
    _assert_not_null_ItemList(value);
    a.push_front(value);

func push_front_nullable(value: ItemList):
    _assert_nullable_ItemList(value);
    a.push_back(value);
