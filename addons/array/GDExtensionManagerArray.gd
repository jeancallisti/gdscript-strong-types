...
# It is not meant to be attached to a GDExtensionManager (unless you want to!)
...
func _assert_nullable_GDExtensionManager(value: GDExtensionManager):
    if (value == null):
        return
...
func _assert_all_nullable_GDExtensionManager(values: Array):
    for v in values:
        _assert_nullable_GDExtensionManager(v)

func _assert_all_not_null_GDExtensionManager(values: Array):
    for v in values:
        _assert_not_null_GDExtensionManager(v)
...
func set_at_nullable(position: int, value: GDExtensionManager):
    _assert_nullable_GDExtensionManager(value);
    a[position] = value;
...
func append_array(array: Array):
    _assert_all_not_null_GDExtensionManager(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_GDExtensionManager(array);
    a.append_array(array);

func back() -> GDExtensionManager:
    return a.back();
...
func count(value: GDExtensionManager) -> int:
    _assert_not_null_GDExtensionManager(value);
    return a.count(value);

func count_nullable(value: GDExtensionManager) -> int:
    _assert_nullable_GDExtensionManager(value);
    return a.count(value);
...
func erase(value: GDExtensionManager):
    _assert_not_null_GDExtensionManager(value);
    a.erase(value);

func erase_nullable(value: GDExtensionManager):
    _assert_nullable_GDExtensionManager(value);
    a.erase(value);

# TODO
# func fill(value: GDExtensionManager)

func find(value: GDExtensionManager) -> int:
    _assert_not_null_GDExtensionManager(value);
    return a.find(value);

func find_nullable(value: GDExtensionManager) -> int:
    _assert_nullable_GDExtensionManager(value);
    return a.find(value);

#TODO
# func find_last(value: GDExtensionManager)

# Returns the first element or crashes if empty
func front() -> GDExtensionManager:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Same as front, but more familiar name
func first() -> GDExtensionManager:
    if (a.empty()):
        _crash("Array is empty");
    return a.front();

# Returns the first element or null if empty
func first_or_default() -> GDExtensionManager:
    if (a.empty()):
        return null;
    return a.front();

func has(value: GDExtensionManager) -> bool:
    _assert_not_null_GDExtensionManager(value);
    return a.has(value);

func has_nullable(value: GDExtensionManager) -> bool:
    _assert_nullable_GDExtensionManager(value);
    return a.has(value);
...
func insert(position: int, value: GDExtensionManager):
    _assert_not_null_GDExtensionManager(value);
    a.insert(position, value);

func insert_nullable(position: int, value: GDExtensionManager):
    _assert_not_null_GDExtensionManager(value);
    a.insert(position, value);
...
func max() -> GDExtensionManager:
    var result: GDExtensionManager = a.max();
    if (result == null): # cf. manual
        _crash("Cannot search max in array. Type is not comparable.");
    return result;

func min() -> GDExtensionManager:
    var result: GDExtensionManager = a.min();
    if (result == null): # cf. manual
        _crash("Cannot search min in array. Type is not comparable.");
    return result;

func pop_at(position: int) -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtensionManager = a.pop_at(position);
    if (result == null): # cf. manual
        _crash("Cannot pop from array. Position invalid");
    return result;

func pop_at_nullable(position: int) -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_back() -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtensionManager = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: GDExtensionManager = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> GDExtensionManager:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: GDExtensionManager):
    _assert_not_null_GDExtensionManager(value);
    a.push_back(value);

func push_back_nullable(value: GDExtensionManager):
    _assert_nullable_GDExtensionManager(value);
    a.push_back(value);


func push_front(value: GDExtensionManager):
    _assert_not_null_GDExtensionManager(value);
    a.push_front(value);

func push_front_nullable(value: GDExtensionManager):
    _assert_nullable_GDExtensionManager(value);
    a.push_back(value);
