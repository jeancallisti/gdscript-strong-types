...
# in which the values are of type 'JSON'.
# It is not meant to be attached to a JSON (unless you want to!)
...
func _assert_nullable_JSON(value: JSON):
    if (value == null):
        return
...
func _assert_all_nullable_JSON(values: Array):
    for v in values:
        _assert_nullable_JSON(v)

func _assert_all_not_null_JSON(values: Array):
    for v in values:
        _assert_not_null_JSON(v)

func set_at(position: int, value: JSON):
    _assert_not_null_JSON(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: JSON):
    _assert_nullable_JSON(value);
    a[position] = value;

func get_at(position: int) -> JSON:
    return a[position];
...
func append_nullable(value: JSON):
    _assert_nullable_JSON(value);
    a.append(value);
...
func append_array(array: Array):
    _assert_all_not_null_JSON(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_JSON(array);
    a.append_array(array);
...
func count(value: JSON) -> int:
    _assert_not_null_JSON(value);
    return a.count(value);

func count_nullable(value: JSON) -> int:
    _assert_nullable_JSON(value);
    return a.count(value);
...
func erase(value: JSON):
    _assert_not_null_JSON(value);
    a.erase(value);

func erase_nullable(value: JSON):
    _assert_nullable_JSON(value);
    a.erase(value);

# TODO
# func fill(value: JSON)

func find(value: JSON) -> int:
    _assert_not_null_JSON(value);
    return a.find(value);

func find_nullable(value: JSON) -> int:
    _assert_nullable_JSON(value);
    return a.find(value);

#TODO
# func find_last(value: JSON)
...
func first_or_default() -> JSON:
    if (a.empty()):
        return null;
    return a.front();

func has(value: JSON) -> bool:
    _assert_not_null_JSON(value);
    return a.has(value);

func has_nullable(value: JSON) -> bool:
    _assert_nullable_JSON(value);
    return a.has(value);
...
func insert(position: int, value: JSON):
    _assert_not_null_JSON(value);
    a.insert(position, value);

func insert_nullable(position: int, value: JSON):
    _assert_not_null_JSON(value);
    a.insert(position, value);
...
func pop_back() -> JSON:
    ...
    var result: JSON = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> JSON:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> JSON:
    ...
    var result: JSON = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> JSON:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: JSON):
    _assert_not_null_JSON(value);
    a.push_back(value);

func push_back_nullable(value: JSON):
    _assert_nullable_JSON(value);
    a.push_back(value);


func push_front(value: JSON):
    _assert_not_null_JSON(value);
    a.push_front(value);

func push_front_nullable(value: JSON):
    _assert_nullable_JSON(value);
    a.push_back(value);
