...
# in which the values are of type 'Sky'.
# It is not meant to be attached to a Sky (unless you want to!)
...
func _assert_nullable_Sky(value: Sky):
    if (value == null):
        return

    if (!(value is Sky)):
        _crash("value was expected to be of type Sky")

func _assert_not_null_Sky(value: Sky):
    if (!(value is Sky)):
        _crash("value was expected to be of type Sky")

func _assert_all_nullable_Sky(values: Array):
    for v in values:
        _assert_nullable_Sky(v)

func _assert_all_not_null_Sky(values: Array):
    for v in values:
        _assert_not_null_Sky(v)

func set_at(position: int, value: Sky):
    _assert_not_null_Sky(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Sky):
    _assert_nullable_Sky(value);
    a[position] = value;

func get_at(position: int) -> Sky:
    return a[position];
...
func add_nullable(value: Sky):
    _assert_nullable_Sky(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Sky):
    _assert_not_null_Sky(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Sky):
    _assert_nullable_Sky(value);
    a.append(value);
...
func count(value: Sky) -> int:
    _assert_not_null_Sky(value);
    return a.count(value);

func count_nullable(value: Sky) -> int:
    _assert_nullable_Sky(value);
    return a.count(value);
...
func erase(value: Sky):
    _assert_not_null_Sky(value);
    a.erase(value);

func erase_nullable(value: Sky):
    _assert_nullable_Sky(value);
    a.erase(value);
...
func find(value: Sky) -> int:
    _assert_not_null_Sky(value);
    return a.find(value);

func find_nullable(value: Sky) -> int:
    _assert_nullable_Sky(value);
    return a.find(value);

#TODO
# func find_last(value: Sky)
...
func first_or_default() -> Sky:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Sky) -> bool:
    _assert_not_null_Sky(value);
    return a.has(value);

func has_nullable(value: Sky) -> bool:
    _assert_nullable_Sky(value);
    return a.has(value);
...
func insert(position: int, value: Sky):
    _assert_not_null_Sky(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Sky):
    _assert_not_null_Sky(value);
    a.insert(position, value);
...
func pop_back() -> Sky:
    ...
    var result: Sky = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Sky:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Sky:
    ...
    var result: Sky = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Sky:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Sky):
    _assert_not_null_Sky(value);
    a.push_back(value);

func push_back_nullable(value: Sky):
    _assert_nullable_Sky(value);
    a.push_back(value);


func push_front(value: Sky):
    _assert_not_null_Sky(value);
    a.push_front(value);

func push_front_nullable(value: Sky):
    _assert_nullable_Sky(value);
    a.push_back(value);
