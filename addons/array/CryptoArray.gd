...
# It is not meant to be attached to a Crypto (unless you want to!)
...
func _assert_nullable_Crypto(value: Crypto):
    if (value == null):
        return
...
func _assert_all_nullable_Crypto(values: Array):
    for v in values:
        _assert_nullable_Crypto(v)

func _assert_all_not_null_Crypto(values: Array):
    for v in values:
        _assert_not_null_Crypto(v)
...
func append_array(array: Array):
    _assert_all_not_null_Crypto(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Crypto(array);
    a.append_array(array);
...
func count(value: Crypto) -> int:
    _assert_not_null_Crypto(value);
    return a.count(value);

func count_nullable(value: Crypto) -> int:
    _assert_nullable_Crypto(value);
    return a.count(value);
...
func erase(value: Crypto):
    _assert_not_null_Crypto(value);
    a.erase(value);

func erase_nullable(value: Crypto):
    _assert_nullable_Crypto(value);
    a.erase(value);

# TODO
# func fill(value: Crypto)

func find(value: Crypto) -> int:
    _assert_not_null_Crypto(value);
    return a.find(value);

func find_nullable(value: Crypto) -> int:
    _assert_nullable_Crypto(value);
    return a.find(value);

#TODO
# func find_last(value: Crypto)
...
func first_or_default() -> Crypto:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Crypto) -> bool:
    _assert_not_null_Crypto(value);
    return a.has(value);

func has_nullable(value: Crypto) -> bool:
    _assert_nullable_Crypto(value);
    return a.has(value);
...
func insert(position: int, value: Crypto):
    _assert_not_null_Crypto(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Crypto):
    _assert_not_null_Crypto(value);
    a.insert(position, value);
...
func pop_back() -> Crypto:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Crypto = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Crypto:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Crypto:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Crypto = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Crypto:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Crypto):
    _assert_not_null_Crypto(value);
    a.push_back(value);

func push_back_nullable(value: Crypto):
    _assert_nullable_Crypto(value);
    a.push_back(value);


func push_front(value: Crypto):
    _assert_not_null_Crypto(value);
    a.push_front(value);

func push_front_nullable(value: Crypto):
    _assert_nullable_Crypto(value);
    a.push_back(value);
