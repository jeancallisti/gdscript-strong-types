...
# in which the values are of type 'AStar'.
# It is not meant to be attached to a AStar (unless you want to!)
# You can generate more classes like this one for your own types.
class_name AStarArray
...
func _assert_nullable_AStar(value: AStar):
    if (value == null):
        return

    if (!(value is AStar)):
        _crash("value was expected to be of type AStar")

func _assert_not_null_AStar(value: AStar):
    if (!(value is AStar)):
        _crash("value was expected to be of type AStar")

func _assert_all_nullable_AStar(values: Array):
    for v in values:
        _assert_nullable_AStar(v)

func _assert_all_not_null_AStar(values: Array):
    for v in values:
        _assert_not_null_AStar(v)

func set_at(position: int, value: AStar):
    _assert_not_null_AStar(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: AStar):
    _assert_nullable_AStar(value);
    a[position] = value;

func get_at(position: int) -> AStar:
    return a[position];

func add(value: AStar):
    _assert_not_null_AStar(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: AStar):
    _assert_nullable_AStar(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: AStar):
    _assert_not_null_AStar(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: AStar):
    _assert_nullable_AStar(value);
    a.append(value);
...
# func Contains(value: AStar) -> bool:
#     _assert_AStar(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_AStar(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_AStar(array);
    a.append_array(array);
...
func count(value: AStar) -> int:
    _assert_not_null_AStar(value);
    return a.count(value);

func count_nullable(value: AStar) -> int:
    _assert_nullable_AStar(value);
    return a.count(value);
...
func erase(value: AStar):
    _assert_not_null_AStar(value);
    a.erase(value);

func erase_nullable(value: AStar):
    _assert_nullable_AStar(value);
    a.erase(value);

# TODO
# func fill(value: AStar)

func find(value: AStar) -> int:
    _assert_not_null_AStar(value);
    return a.find(value);

func find_nullable(value: AStar) -> int:
    _assert_nullable_AStar(value);
    return a.find(value);

#TODO
# func find_last(value: AStar)
...
func first_or_default() -> AStar:
    if (a.empty()):
        return null;
    return a.front();

func has(value: AStar) -> bool:
    _assert_not_null_AStar(value);
    return a.has(value);

func has_nullable(value: AStar) -> bool:
    _assert_nullable_AStar(value);
    return a.has(value);
...
func insert(position: int, value: AStar):
    _assert_not_null_AStar(value);
    a.insert(position, value);

func insert_nullable(position: int, value: AStar):
    _assert_not_null_AStar(value);
    a.insert(position, value);
...
func pop_back() -> AStar:
    ...
    var result: AStar = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> AStar:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> AStar:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: AStar = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> AStar:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: AStar):
    _assert_not_null_AStar(value);
    a.push_back(value);

func push_back_nullable(value: AStar):
    _assert_nullable_AStar(value);
    a.push_back(value);


func push_front(value: AStar):
    _assert_not_null_AStar(value);
    a.push_front(value);

func push_front_nullable(value: AStar):
    _assert_nullable_AStar(value);
    a.push_back(value);
