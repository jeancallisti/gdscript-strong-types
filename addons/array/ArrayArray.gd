...
# in which the values are of type 'Array'.
# It is not meant to be attached to a Array (unless you want to!)
# You can generate more classes like this one for your own types.
class_name ArrayArray
...
func _assert_nullable_Array(value: Array):
    if (value == null):
        return

    if (!(value is Array)):
        _crash("value was expected to be of type Array")

func _assert_not_null_Array(value: Array):
    if (!(value is Array)):
        _crash("value was expected to be of type Array")

func _assert_all_nullable_Array(values: Array):
    for v in values:
        _assert_nullable_Array(v)

func _assert_all_not_null_Array(values: Array):
    for v in values:
        _assert_not_null_Array(v)

func set_at(position: int, value: Array):
    _assert_not_null_Array(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Array):
    _assert_nullable_Array(value);
    a[position] = value;

func get_at(position: int) -> Array:
    return a[position];

func add(value: Array):
    _assert_not_null_Array(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Array):
    _assert_nullable_Array(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Array):
    _assert_not_null_Array(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Array):
    _assert_nullable_Array(value);
    a.append(value);
...
# func Contains(value: Array) -> bool:
#     _assert_Array(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Array(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Array(array);
    a.append_array(array);
...
func count(value: Array) -> int:
    _assert_not_null_Array(value);
    return a.count(value);

func count_nullable(value: Array) -> int:
    _assert_nullable_Array(value);
    return a.count(value);
...
func erase(value: Array):
    _assert_not_null_Array(value);
    a.erase(value);

func erase_nullable(value: Array):
    _assert_nullable_Array(value);
    a.erase(value);

# TODO
# func fill(value: Array)

func find(value: Array) -> int:
    _assert_not_null_Array(value);
    return a.find(value);

func find_nullable(value: Array) -> int:
    _assert_nullable_Array(value);
    return a.find(value);

#TODO
# func find_last(value: Array)
...
func first_or_default() -> Array:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Array) -> bool:
    _assert_not_null_Array(value);
    return a.has(value);

func has_nullable(value: Array) -> bool:
    _assert_nullable_Array(value);
    return a.has(value);
...
func insert(position: int, value: Array):
    _assert_not_null_Array(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Array):
    _assert_not_null_Array(value);
    a.insert(position, value);
...
func pop_back() -> Array:
    ...
    var result: Array = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Array:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Array:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Array = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Array:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Array):
    _assert_not_null_Array(value);
    a.push_back(value);

func push_back_nullable(value: Array):
    _assert_nullable_Array(value);
    a.push_back(value);


func push_front(value: Array):
    _assert_not_null_Array(value);
    a.push_front(value);

func push_front_nullable(value: Array):
    _assert_nullable_Array(value);
    a.push_back(value);
