...
# in which the values are of type 'Quat'.
# It is not meant to be attached to a Quat (unless you want to!)
# You can generate more classes like this one for your own types.
class_name QuatArray
...
func _assert_nullable_Quat(value: Quat):
    if (value == null):
        return

    if (!(value is Quat)):
        _crash("value was expected to be of type Quat")

func _assert_not_null_Quat(value: Quat):
    if (!(value is Quat)):
        _crash("value was expected to be of type Quat")

func _assert_all_nullable_Quat(values: Array):
    for v in values:
        _assert_nullable_Quat(v)

func _assert_all_not_null_Quat(values: Array):
    for v in values:
        _assert_not_null_Quat(v)

func set_at(position: int, value: Quat):
    _assert_not_null_Quat(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Quat):
    _assert_nullable_Quat(value);
    a[position] = value;

func get_at(position: int) -> Quat:
    return a[position];
...
func add_nullable(value: Quat):
    _assert_nullable_Quat(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Quat):
    _assert_not_null_Quat(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Quat):
    _assert_nullable_Quat(value);
    a.append(value);
...
# func Contains(value: Quat) -> bool:
#     _assert_Quat(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Quat(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Quat(array);
    a.append_array(array);
...
func count(value: Quat) -> int:
    _assert_not_null_Quat(value);
    return a.count(value);

func count_nullable(value: Quat) -> int:
    _assert_nullable_Quat(value);
    return a.count(value);
...
func erase(value: Quat):
    _assert_not_null_Quat(value);
    a.erase(value);

func erase_nullable(value: Quat):
    _assert_nullable_Quat(value);
    a.erase(value);

# TODO
# func fill(value: Quat)

func find(value: Quat) -> int:
    _assert_not_null_Quat(value);
    return a.find(value);

func find_nullable(value: Quat) -> int:
    _assert_nullable_Quat(value);
    return a.find(value);

#TODO
# func find_last(value: Quat)
...
func first_or_default() -> Quat:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Quat) -> bool:
    _assert_not_null_Quat(value);
    return a.has(value);

func has_nullable(value: Quat) -> bool:
    _assert_nullable_Quat(value);
    return a.has(value);
...
func insert(position: int, value: Quat):
    _assert_not_null_Quat(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Quat):
    _assert_not_null_Quat(value);
    a.insert(position, value);
...
func pop_back() -> Quat:
    ...
    var result: Quat = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Quat:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Quat:
    ...
    var result: Quat = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Quat:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Quat):
    _assert_not_null_Quat(value);
    a.push_back(value);

func push_back_nullable(value: Quat):
    _assert_nullable_Quat(value);
    a.push_back(value);


func push_front(value: Quat):
    _assert_not_null_Quat(value);
    a.push_front(value);

func push_front_nullable(value: Quat):
    _assert_nullable_Quat(value);
    a.push_back(value);
