...
# in which the values are of type 'Range'.
# It is not meant to be attached to a Range (unless you want to!)
# You can generate more classes like this one for your own types.
class_name RangeArray
...
func _assert_nullable_Range(value: Range):
    if (value == null):
        return

    if (!(value is Range)):
        _crash("value was expected to be of type Range")

func _assert_not_null_Range(value: Range):
    if (!(value is Range)):
        _crash("value was expected to be of type Range")

func _assert_all_nullable_Range(values: Array):
    for v in values:
        _assert_nullable_Range(v)

func _assert_all_not_null_Range(values: Array):
    for v in values:
        _assert_not_null_Range(v)

func set_at(position: int, value: Range):
    _assert_not_null_Range(value);
    a[position] = value;

# Same as set_at but allows null
func set_at_nullable(position: int, value: Range):
    _assert_nullable_Range(value);
    a[position] = value;

func get_at(position: int) -> Range:
    return a[position];

func add(value: Range):
    _assert_not_null_Range(value);
    a.append(value);

# Same as add but allows null
func add_nullable(value: Range):
    _assert_nullable_Range(value);
    a.append(value);

# Same as add, but with a different name.
func append(value: Range):
    _assert_not_null_Range(value);
    a.append(value);

# Same as add_nullable, but with a different name.
func append_nullable(value: Range):
    _assert_nullable_Range(value);
    a.append(value);
...
# func Contains(value: Range) -> bool:
#     _assert_Range(value);
#     return a.contains(value);


func append_array(array: Array):
    _assert_all_not_null_Range(array);
    a.append_array(array);

func append_array_nullable(array: Array):
    _assert_all_nullable_Range(array);
    a.append_array(array);
...
func count(value: Range) -> int:
    _assert_not_null_Range(value);
    return a.count(value);

func count_nullable(value: Range) -> int:
    _assert_nullable_Range(value);
    return a.count(value);
...
func erase(value: Range):
    _assert_not_null_Range(value);
    a.erase(value);

func erase_nullable(value: Range):
    _assert_nullable_Range(value);
    a.erase(value);

# TODO
# func fill(value: Range)

func find(value: Range) -> int:
    _assert_not_null_Range(value);
    return a.find(value);

func find_nullable(value: Range) -> int:
    _assert_nullable_Range(value);
    return a.find(value);

#TODO
# func find_last(value: Range)
...
func first_or_default() -> Range:
    if (a.empty()):
        return null;
    return a.front();

func has(value: Range) -> bool:
    _assert_not_null_Range(value);
    return a.has(value);

func has_nullable(value: Range) -> bool:
    _assert_nullable_Range(value);
    return a.has(value);
...
func insert(position: int, value: Range):
    _assert_not_null_Range(value);
    a.insert(position, value);

func insert_nullable(position: int, value: Range):
    _assert_not_null_Range(value);
    a.insert(position, value);
...
func pop_back() -> Range:
    ...
    var result: Range = a.pop_back();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_back_nullable() -> Range:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func pop_front() -> Range:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")

    var result: Range = a.pop_front();
    if (result == null): # cf. manual
        _crash("Cannot pop from array (unexpected: null).");
    return result;

func pop_front_nullable() -> Range:
    if (a.size() == 0):
        _crash("Cannot pop from empty array")
...
func push_back(value: Range):
    _assert_not_null_Range(value);
    a.push_back(value);

func push_back_nullable(value: Range):
    _assert_nullable_Range(value);
    a.push_back(value);


func push_front(value: Range):
    _assert_not_null_Range(value);
    a.push_front(value);

func push_front_nullable(value: Range):
    _assert_nullable_Range(value);
    a.push_back(value);
